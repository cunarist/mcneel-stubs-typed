...
class CentralSettings:
    ...
    def AuthorAddress() -> None: ...
    @overload
    @AuthorCompany.setter
    def AuthorCompany() -> None: ...
    @overload
    @AuthorCopyright.setter
    def AuthorCopyright() -> None: ...
    @overload
    @AuthorEMail.setter
    def AuthorEMail() -> None: ...
    @overload
    @AuthorName.setter
    def AuthorName() -> None: ...
    @overload
    @AuthorPhone.setter
    def AuthorPhone() -> None: ...
    @overload
    @AuthorWebsite.setter
    def AuthorWebsite() -> None: ...
    @overload
    @CanvasFancyWires.setter
    def CanvasFancyWires() -> None: ...
    @overload
    @CanvasFullNames.setter
    def CanvasFullNames() -> None: ...
    @overload
    @CanvasMaxSearchResults.setter
    def CanvasMaxSearchResults() -> None: ...
    @overload
    @CanvasObjectIcons.setter
    def CanvasObjectIcons() -> None: ...
    @overload
    @CanvasObsoleteTags.setter
    def CanvasObsoleteTags() -> None: ...
    @overload
    @CanvasRadialMenu.setter
    def CanvasRadialMenu() -> None: ...
    @overload
    @CanvasSpaceIsRadialMenu.setter
    def CanvasSpaceIsRadialMenu() -> None: ...
    @overload
    @CanvasSpaceSearchRadialMessage.setter
    def CanvasSpaceSearchRadialMessage() -> None: ...
    @overload
    @CanvasToolbar.setter
    def CanvasToolbar() -> None: ...
    @overload
    @CanvasZuiZoomLevel.setter
    def CanvasZuiZoomLevel() -> None: ...
    @overload
    @ComponentCascadeMenus.setter
    def ComponentCascadeMenus() -> None: ...
    @overload
    @CreateSolutionUndoRecord.setter
    def CreateSolutionUndoRecord() -> None: ...
    @overload
    @FormatDecimalDigits.setter
    def FormatDecimalDigits() -> None: ...
    @overload
    @FormatENotationDigits.setter
    def FormatENotationDigits() -> None: ...
    @overload
    @FormatENotationLowerLimit.setter
    def FormatENotationLowerLimit() -> None: ...
    @overload
    @FormatENotationUpperLimit.setter
    def FormatENotationUpperLimit() -> None: ...
    @overload
    @FormatMultiplesOfOne.setter
    def FormatMultiplesOfOne() -> None: ...
    @overload
    @FormatMultiplesOfPi.setter
    def FormatMultiplesOfPi() -> None: ...
    @overload
    @InvalidBakeAllow.setter
    def InvalidBakeAllow() -> None: ...
    @overload
    @InvalidBakeAsk.setter
    def InvalidBakeAsk() -> None: ...
    @overload
    @PanelDefaultFontFamily.setter
    def PanelDefaultFontFamily() -> None: ...
    @overload
    @PanelDefaultFontSize.setter
    def PanelDefaultFontSize() -> None: ...
    @overload
    @PreviewBumpZBuffer.setter
    def PreviewBumpZBuffer() -> None: ...
    @overload
    @PreviewGumballs.setter
    def PreviewGumballs() -> None: ...
    @overload
    @PreviewMeshEdges.setter
    def PreviewMeshEdges() -> None: ...
    @overload
    @PreviewPlaneRadius.setter
    def PreviewPlaneRadius() -> None: ...
    @overload
    @PreviewPointStyle.setter
    def PreviewPointStyle() -> None: ...
    @overload
    @PreviewSelectionThickening.setter
    def PreviewSelectionThickening() -> None: ...
    @overload
    @PruderyLevel.setter
    def PruderyLevel() -> None: ...
    @overload
    @RibbonDrawTabIcons.setter
    def RibbonDrawTabIcons() -> None: ...
    @overload
    @RibbonSeparators.setter
    def RibbonSeparators() -> None: ...
    @overload
    @RibbonShowObscure.setter
    def RibbonShowObscure() -> None: ...
    @overload
    @RibbonVisible.setter
    def RibbonVisible() -> None: ...
    @overload
    @ShowTutorials.setter
    def ShowTutorials() -> None: ...
    @overload
    @TemplateFile.setter
    def TemplateFile() -> None: ...
    @overload
    @TooltipWiggleRadius.setter
    def TooltipWiggleRadius() -> None: ...
    @overload
    @TrackFileStamps.setter
    def TrackFileStamps() -> None: ...
    @overload
    @TrackPluginLoading.setter
    def TrackPluginLoading() -> None: ...
    @overload
    @TryDownloadMissingPlugins.setter
    def TryDownloadMissingPlugins() -> None: ...
    @overload
    @staticmethod
...
class Folders:
    ...
    def CustomAssemblyFolders() -> None: ...
    @overload
    @staticmethod
...
class Instances:
    ...
    def AutoHideBanner() -> None: ...
    @overload
    @AutoShowBanner.setter
    def AutoShowBanner() -> None: ...
    @overload
    @staticmethod
