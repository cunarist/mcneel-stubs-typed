...
class GH_GDI_Util:
    ...
    @overload
    def FilletPolyline(corners: Iterable[PointF], radius: Single) -> GraphicsPath: ...
...
class GH_ValueListEditor:
    def __init__(self): ...
    def AssignValues(self, values: IterableGH_ValueListItem]) -> None: ...
    @property
