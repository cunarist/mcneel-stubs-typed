...
class GH_CodeStringSegment:
    ...
    @overload
    @IsCode.setter
    def IsCode(self) -> MutableSequence[bool]: ...
    @overload
    @String.setter
    def String(self) -> MutableSequence[str]: ...
    @overload
    def ToString(self) -> str: ...
...
class GH_ExpressionParser:
    ...
    def ThrowExceptions(self) -> MutableSequence[bool]: ...
    @overload
    def ToString(self) -> str: ...
