...
class GH_GraphicBranch:
    ...
    @Angle.setter
    def Angle(self) -> MutableSequence[Single]: ...
    @Data.setter
    def Data(self) -> MutableSequence[IList]: ...
    @Length.setter
    def Length(self) -> MutableSequence[Single]: ...
    @Offset.setter
    def Offset(self) -> MutableSequence[Single]: ...
    @Parent.setter
    def Parent(self) -> MutableSequence[GH_GraphicBranch]: ...
    @Path.setter
    def Path(self) -> MutableSequence[GH_Path]: ...
    @Selected.setter
    def Selected(self) -> MutableSequence[bool]: ...
    @Twigs.setter
    def Twigs(self) -> MutableSequence[List]: ...
...
class GH_LexerCombo:
    ...
    def GetType(self) -> Type: ...
    @Source.setter
    def Source(self) -> MutableSequence[GH_Lexer]: ...
    @Target.setter
    def Target(self) -> MutableSequence[GH_Lexer]: ...
    def ToString(self) -> str: ...
...
class GH_Path:
    ...
    @Indices.setter
    def Indices(self) -> MutableSequence[Iterable[int]]: ...
    @InternalPath.setter
    def InternalPath(self) -> MutableSequence[Iterable[int]]: ...
    @staticmethod
...
class GH_PathOffset:
    ...
    @ItemOffset.setter
    def ItemOffset(self) -> MutableSequence[int]: ...
    @ItemWrap.setter
    def ItemWrap(self) -> MutableSequence[bool]: ...
    @PathWrap.setter
    def PathWrap(self) -> MutableSequence[bool]: ...
    def ToString(self) -> str: ...
...
class IGH_Structure:
    ...
    @property
    def Branch(self) -> Sequence[int]: ...
    @property
    def Branch(self) -> Sequence[GH_Path]: ...
    @property
    def DataCount(self) -> int: ...
    @property
    def IsEmpty(self) -> bool: ...
