...
class GH_GraphContainer:
    ...
    @overload
    @DisplayScale.setter
    def DisplayScale(self) -> MutableSequence[Single]: ...
    @overload
    @Graph.setter
    def Graph(self) -> MutableSequence[IGH_Graph]: ...
    @overload
    @LockGrips.setter
    def LockGrips(self) -> MutableSequence[bool]: ...
    @overload
    @Region.setter
    def Region(self) -> MutableSequence[RectangleF]: ...
    @overload
    @X0.setter
    def X0(self) -> MutableSequence[float]: ...
    @overload
    @X1.setter
    def X1(self) -> MutableSequence[float]: ...
    @overload
    @Y0.setter
    def Y0(self) -> MutableSequence[float]: ...
    @overload
    @Y1.setter
    def Y1(self) -> MutableSequence[float]: ...
    @overload
...
class GH_GraphGrip:
    ...
    @overload
    @Constraint.setter
    def Constraint(self) -> MutableSequence[GH_GripConstraint]: ...
    @overload
    @X.setter
...
class GH_LinearGraphProxy:
    ...
    @overload
    @Intercept.setter
    def Intercept(self) -> MutableSequence[float]: ...
    @overload
    @Slope.setter
    def Slope(self) -> MutableSequence[float]: ...
    @overload
    def ToString(self) -> str: ...
