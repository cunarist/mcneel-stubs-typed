...
class GH_Alias:
    ...
    @overload
    @Alias.setter
    def Alias(self) -> MutableSequence[str]: ...
    @overload
    @Target.setter
    def Target(self) -> MutableSequence[Guid]: ...
    @overload
    @staticmethod
...
class GH_Author:
    ...
    @overload
    @Address.setter
    def Address(self) -> MutableSequence[str]: ...
    @overload
    @Company.setter
    def Company(self) -> MutableSequence[str]: ...
    @overload
    @Copyright.setter
    def Copyright(self) -> MutableSequence[str]: ...
    @overload
    @EMail.setter
    def EMail(self) -> MutableSequence[str]: ...
    @overload
    @Name.setter
    def Name(self) -> MutableSequence[str]: ...
    @overload
    @Phone.setter
    def Phone(self) -> MutableSequence[str]: ...
    @overload
    @Website.setter
    def Website(self) -> MutableSequence[str]: ...
    @overload
    def ToString(self) -> str: ...
    @overload
    def Write(self, writer: GH_IWriter) -> bool: ...
...
class GH_AutoSaveSettings:
    ...
    def EnableAutoSave() -> None: ...
    @overload
    @SaveOnDataFlattening.setter
    def SaveOnDataFlattening() -> None: ...
    @overload
    @SaveOnDocumentUnload.setter
    def SaveOnDocumentUnload() -> None: ...
    @overload
    @SaveOnObjectAdded.setter
    def SaveOnObjectAdded() -> None: ...
    @overload
    @SaveOnObjectChange.setter
    def SaveOnObjectChange() -> None: ...
    @overload
    @SaveOnObjectRemoved.setter
    def SaveOnObjectRemoved() -> None: ...
    @overload
    @SaveOnWireEvent.setter
    def SaveOnWireEvent() -> None: ...
    @overload
    def ToString(self) -> str: ...
...
class GH_Document:
    ...
    @overload
    @Context.setter
    def Context(self) -> MutableSequence[GH_DocumentContext]: ...
    @overload
    @DefaultPreviewColour.setter
    def DefaultPreviewColour() -> None: ...
    @overload
    @DefaultSelectedPreviewColour.setter
    def DefaultSelectedPreviewColour() -> None: ...
    @overload
    @Enabled.setter
    def Enabled(self) -> MutableSequence[bool]: ...
    @overload
    @EnableSolutions.setter
    def EnableSolutions() -> None: ...
    @overload
    @FilePath.setter
    def FilePath(self) -> MutableSequence[str]: ...
    @overload
    @IsModified.setter
    def IsModified(self) -> MutableSequence[bool]: ...
    @overload
    @Nested.setter
    def Nested(self) -> MutableSequence[bool]: ...
    @overload
    @Owner.setter
    def Owner(self) -> MutableSequence[IGH_DocumentOwner]: ...
    @overload
    @PreviewBoundary.setter
    def PreviewBoundary(self) -> MutableSequence[GH_PreviewBoundary]: ...
    @overload
    @PreviewColour.setter
    def PreviewColour(self) -> MutableSequence[Color]: ...
    @overload
    @PreviewColourSelected.setter
    def PreviewColourSelected(self) -> MutableSequence[Color]: ...
    @overload
    @PreviewCustomMeshParameters.setter
    def PreviewCustomMeshParameters(self) -> MutableSequence[MeshingParameters]: ...
    @overload
    @PreviewFilter.setter
    def PreviewFilter(self) -> MutableSequence[GH_PreviewFilter]: ...
    @overload
    @PreviewMeshType.setter
    def PreviewMeshType(self) -> MutableSequence[GH_PreviewMesh]: ...
    @overload
    @PreviewMode.setter
    def PreviewMode(self) -> MutableSequence[GH_PreviewMode]: ...
    @overload
    @Profiler.setter
    def Profiler(self) -> MutableSequence[GH_ProfilerMode]: ...
    @overload
    @RaiseEvents.setter
    def RaiseEvents(self) -> MutableSequence[bool]: ...
    @overload
    @Thumbnail.setter
    def Thumbnail(self) -> MutableSequence[Bitmap]: ...
    @overload
...
class GH_DocumentIO:
    ...
    def DisableOverwriteProtection() -> None: ...
    @overload
    @Document.setter
...
class GH_DocumentProperties:
    ...
    @overload
    @DateTag.setter
    def DateTag(self) -> MutableSequence[DateTime]: ...
    @overload
    @Description.setter
    def Description(self) -> MutableSequence[str]: ...
    @overload
    @IconImageData.setter
    def IconImageData(self) -> MutableSequence[str]: ...
    @overload
    @ProjectFileName.setter
    def ProjectFileName(self) -> MutableSequence[str]: ...
    @overload
    @ViewTarget.setter
    def ViewTarget(self) -> MutableSequence[Point]: ...
    @overload
    @ZoomFactor.setter
    def ZoomFactor(self) -> MutableSequence[Single]: ...
    @overload
    def ToString(self) -> str: ...
    @overload
    def Write(self, writer: GH_IWriter) -> bool: ...
...
class GH_DocumentServer:
    ...
    @overload
    @property
    def Document(self) -> Sequence[int]: ...
    @overload
    @property
...
class GH_FileWatcher:
    ...
    @overload
    @Active.setter
    def Active(self) -> MutableSequence[bool]: ...
    @overload
    @Buffer.setter
    def Buffer(self) -> MutableSequence[TimeSpan]: ...
    @overload
    @InvokeOnDefaultThread.setter
    def InvokeOnDefaultThread(self) -> MutableSequence[bool]: ...
    @overload
...
class GH_FontServer:
    ...
    def FamilyConsole() -> None: ...
    @overload
    @FamilyScript.setter
    def FamilyScript() -> None: ...
    @overload
    @FamilyStandard.setter
    def FamilyStandard() -> None: ...
    @overload
    @staticmethod
...
class GH_MarkovOutcome:
    ...
    @overload
    @Valence.setter
    def Valence(self) -> MutableSequence[Int64]: ...
    @overload
    def ToString(self) -> str: ...
...
class GH_ParameterContext:
    ...
    @overload
    @SolveIndex.setter
    def SolveIndex(self) -> MutableSequence[int]: ...
    @overload
    def ToString(self) -> str: ...
...
class GH_PreviewUtil:
    ...
    @overload
    @WireColour.setter
    def WireColour(self) -> MutableSequence[Color]: ...
    @overload
    def ToString(self) -> str: ...
...
class GH_StateTag:
    ...
    @overload
    @Stage.setter
    def Stage(self) -> MutableSequence[Rectangle]: ...
    @overload
    @StateDescription.setter
    def StateDescription(self) -> MutableSequence[str]: ...
    @overload
    def ToString(self) -> str: ...
...
class GH_StringPattern:
    ...
    @overload
    @StackDepth.setter
    def StackDepth(self) -> MutableSequence[int]: ...
    @overload
...
class GH_UserObject:
    ...
    @overload
    @BaseGuid.setter
    def BaseGuid(self) -> MutableSequence[Guid]: ...
    @overload
    @Data.setter
    def Data(self) -> MutableSequence[Iterable[Byte]]: ...
    @overload
    @Description.setter
    def Description(self) -> MutableSequence[GH_InstanceDescription]: ...
    @overload
    @Exposure.setter
    def Exposure(self) -> MutableSequence[GH_Exposure]: ...
    @overload
    @Guid.setter
    def Guid(self) -> MutableSequence[Guid]: ...
    @overload
    @Icon.setter
    def Icon(self) -> MutableSequence[Bitmap]: ...
    @overload
    @Path.setter
...
class IGH_Component:
    ...
    def MasterParameterIndex(self) -> MutableSequence[int]: ...
    @overload
    @Message.setter
    def Message(self) -> MutableSequence[str]: ...
...
class IGH_TaskCapableComponent:
    ...
    @overload
    @InPreSolve.setter
    def InPreSolve(self) -> MutableSequence[bool]: ...
    @overload
    @UseTasks.setter
    def UseTasks(self) -> MutableSequence[bool]: ...
