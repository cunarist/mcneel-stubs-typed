...
class GH_ComponentServer:
    ...
    @property
    def GraphProxies(self) -> IterableGH_GraphProxy]: ...
    @property
    def Libraries(self) -> ReadOnlyCollection: ...
    @property
    def LoadingExceptions(self) -> List: ...
    @property
    def ObjectProxies(self) -> IterableIGH_ObjectProxy]: ...
    @property
    def ObjectProxyNames(self) -> AutoCompleteStringCollection: ...
    @property
    def TypeHints(self) -> IterableType]: ...
    @property
    def Upgraders(self) -> IterableIGH_UpgradeObject]: ...
...
class GH_Document:
    ...
    @property
    def Attributes(self) -> IterableIGH_Attributes]: ...
    @property
    ...
    def ObjectCount(self) -> int: ...
    @property
    def Objects(self) -> IterableIGH_DocumentObject]: ...
    @property
    ...
    def Write(self, writer: GH_IWriter) -> bool: ...
    @overload
    def Write(self, writer: GH_IWriter, objList: IterableIGH_DocumentObject]) -> bool: ...
