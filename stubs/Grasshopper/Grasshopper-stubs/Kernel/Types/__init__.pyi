...
class Complex:
    ...
    @overload
    def __radd__(A: float, B: Complex) -> Complex: ...
    @overload
    def __rtruediv__(dividend: float, divisor: Complex) -> Complex: ...
    @overload
