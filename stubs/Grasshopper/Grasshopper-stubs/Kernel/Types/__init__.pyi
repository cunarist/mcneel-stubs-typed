...
class Complex:
    ...
    @overload
    def __add__(A: float, B: Complex) -> Complex: ...
    @overload
    def __truediv__(dividend: float, divisor: Complex) -> Complex: ...
    @overload
