...
class Complex:
    ...
    @overload
    def __truediv__(divisor: Complex, dividend: Complex) -> Complex: ...
    @overload
    def __truediv__(divisor: float, dividend: Complex) -> Complex: ...
    @overload
    def __mul__(B: float, A: Complex) -> Complex: ...
    @overload
    def __rmul__(B: Complex, A: float) -> Complex: ...
    @overload
    def __mul__(B: Complex, A: Complex) -> Complex: ...
    @overload
    def __sub__(B: Complex, A: Complex) -> Complex: ...
    @overload
    def __rsub__(B: Complex, A: float) -> Complex: ...
    @overload
    def __sub__(B: float, A: Complex) -> Complex: ...
