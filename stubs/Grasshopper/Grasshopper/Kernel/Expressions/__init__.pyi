...
class GH_CodeString:
    ...
    @property
    def Segments(self) -> MutableSequence[GH_CodeStringSegment]: ...
    @overload
...
class GH_ExpressionString:
    ...
    @overload
    def AddRange(self, collection: Iterable[str]) -> None: ...
    @overload
    def AsReadOnly(self) -> ReadOnlyCollection: ...
    @overload
    def BinarySearch(self, item: str) -> int: ...
    @overload
    def BinarySearch(self, item: str, comparer: IComparer) -> int: ...
    @overload
    def BinarySearch(self, index: int, count: int, item: str, comparer: IComparer) -> int: ...
    @overload
    ...
    @overload
    def CopyTo(self, array: Iterable[str]) -> None: ...
    @overload
    def CopyTo(self, array: Iterable[str], arrayIndex: int) -> None: ...
    @overload
    def CopyTo(self, index: int, array: Iterable[str], arrayIndex: int, count: int) -> None: ...
    @overload
    def Equals(self, obj: object) -> bool: ...
    @overload
    def Exists(self, match: Predicate) -> bool: ...
    @overload
    def Find(self, match: Predicate) -> str: ...
    @overload
    def FindAll(self, match: Predicate) -> MutableSequence[str]: ...
    @overload
    ...
    @overload
    def FindLast(self, match: Predicate) -> str: ...
    @overload
    ...
    @property
    def Char(self) -> Sequence[str]: ...
    @property
    def Count(self) -> int: ...
    @property
    def Next(self) -> Sequence[str]: ...
    @property
    def Prev(self) -> Sequence[str]: ...
    @overload
    def GetEnumerator(self) -> Enumerator: ...
    @overload
    def GetHashCode(self) -> int: ...
    @overload
    def GetRange(self, index: int, count: int) -> MutableSequence[str]: ...
    @overload
    def GetType(self) -> type: ...
    @overload
    def IndexOf(self, item: str) -> int: ...
    @overload
    def IndexOf(self, item: str, index: int) -> int: ...
    @overload
    def IndexOf(self, item: str, index: int, count: int) -> int: ...
    @overload
    def Insert(self, index: int, item: str) -> None: ...
    @overload
    def InsertRange(self, index: int, collection: Iterable[str]) -> None: ...
    @overload
    def IsWhiteSpace(self, index: int) -> bool: ...
    @overload
    def LastIndexOf(self, item: str) -> int: ...
    @overload
    def LastIndexOf(self, item: str, index: int) -> int: ...
    @overload
    def LastIndexOf(self, item: str, index: int, count: int) -> int: ...
    @overload
...
class GH_ParserOperator:
    @overload
    def __init__(self, name: str, symbol: str, precedence: GH_ParserPrecedence, type: GH_OperatorType, description: str): ...
    m_name: str
    m_symbol: str
    m_description: str
