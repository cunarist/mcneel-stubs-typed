...
class Connectivity:
    ...
    def Count(self) -> int: ...
    @overload
    def GetConnections(self, node_index: int) -> MutableSequence[int]: ...
    @overload
    def GetHashCode(self) -> int: ...
    @overload
    def GetType(self) -> type: ...
    @overload
    def SolveConnectivity(self, nodes: Node2List, faces: MutableSequence[Face], include_convex_hull_edges: bool) -> None: ...
    @overload
...
class EdgeList:
    ...
    def __init__(self): ...
    @overload
    def __init__(self, F: MutableSequence[FaceEx]): ...
    @overload
    def __init__(self, F: MutableSequence[Face]): ...
    @overload
...
class FaceExList:
    ...
    def Clear(self) -> None: ...
    @overload
    def CullFaces(self, x: float, y: float, F: MutableSequence[FaceEx]) -> int: ...
    @overload
    def Equals(self, obj: object) -> bool: ...
    @property
    def Capacity(self) -> int: ...
    ...
    @overload
    def MigrateRemainingFaces(self, static_list: MutableSequence[Face]) -> None: ...
    @overload
    def MigrateStaticFaces(self, static_list: MutableSequence[Face], wave_front: float) -> int: ...
    @Capacity.setter
    def Capacity(self, Value: int) -> None: ...
    @overload
    def ToString(self) -> str: ...
