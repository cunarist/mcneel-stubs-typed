...
class GH_AutoSaveSettings:
    ...
    @classmethod
    def EnableAutoSave(cls, Value: bool) -> None: ...
    @SaveOnDataFlattening.setter
    @classmethod
    def SaveOnDataFlattening(cls, Value: bool) -> None: ...
    @SaveOnDocumentUnload.setter
    @classmethod
    def SaveOnDocumentUnload(cls, Value: bool) -> None: ...
    @SaveOnObjectAdded.setter
    @classmethod
    def SaveOnObjectAdded(cls, Value: bool) -> None: ...
    @SaveOnObjectChange.setter
    @classmethod
    def SaveOnObjectChange(cls, Value: bool) -> None: ...
    @SaveOnObjectRemoved.setter
    @classmethod
    def SaveOnObjectRemoved(cls, Value: bool) -> None: ...
    @SaveOnWireEvent.setter
    @classmethod
    def SaveOnWireEvent(cls, Value: bool) -> None: ...
    @overload
    def ToString(self) -> str: ...
...
class GH_Document:
    ...
    @classmethod
    def DefaultPreviewColour(cls, Value: Color) -> None: ...
    @DefaultSelectedPreviewColour.setter
    @classmethod
    def DefaultSelectedPreviewColour(cls, Value: Color) -> None: ...
    @Enabled.setter
    def Enabled(self, Value: bool) -> None: ...
    @EnableSolutions.setter
    @classmethod
    def EnableSolutions(cls, Value: bool) -> None: ...
    @FilePath.setter
...
class GH_DocumentIO:
    ...
    @classmethod
    def DisableOverwriteProtection(cls, AutoPropertyValue: bool) -> None: ...
    @Document.setter
...
class GH_FontServer:
    ...
    @classmethod
    def FamilyConsole(cls, Value: FontFamily) -> None: ...
    @FamilyScript.setter
    @classmethod
    def FamilyScript(cls, Value: FontFamily) -> None: ...
    @FamilyStandard.setter
    @classmethod
    def FamilyStandard(cls, Value: FontFamily) -> None: ...
    @overload
    @staticmethod
