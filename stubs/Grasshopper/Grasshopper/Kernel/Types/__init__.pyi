...
class Complex:
    ...
    @property
    @classmethod
    def ComplexUnit(cls) -> Complex: ...
    @property
    def Imaginary(self) -> float: ...
    @property
    @classmethod
    def Infinity(cls) -> Complex: ...
    @property
    ...
    @property
    @classmethod
    def NegativeInfinity(cls) -> Complex: ...
    @property
    def Real(self) -> float: ...
    @property
    @classmethod
...
class GH_Field:
    ...
    def ClippingBox(self) -> BoundingBox: ...
    @property
    def Elements(self) -> MutableSequence[IGH_FieldElement]: ...
    @property
    def IsValid(self) -> bool: ...
    @property
    def IsValidWhyNot(self) -> str: ...
...
class GH_GeometryGroup:
    ...
    def Name(self) -> str: ...
    @property
    def Objects(self) -> MutableSequence[IGH_GeometricGoo]: ...
    @property
    def ReferenceID(self) -> Guid: ...
    @property
    def TypeDescription(self) -> str: ...
...
class GH_PointUtil:
    ...
    @overload
    @staticmethod
    def ProjectPointsToPlane(pts: Iterable[GH_Point], plane: Plane, include_nulls: bool) -> MutableSequence[GH_Point]: ...
    @overload
    @staticmethod
    def PullPointsToPlane(pts: Iterable[GH_Point], plane: Plane, include_nulls: bool) -> MutableSequence[GH_Point]: ...
    @overload
    @staticmethod
    def RemapPointsToPlane(pts: Iterable[GH_Point], plane: Plane, include_nulls: bool) -> MutableSequence[GH_Point]: ...
    @overload
    def ToString(self) -> str: ...
...
class GH_Predicate:
    ...
    @property
    @classmethod
    def Empty(cls) -> GH_Predicate: ...
    @property
    @classmethod
    def False(cls) -> GH_Predicate: ...
    @property
    def IsValid(self) -> bool: ...
    @property
    def IsValidWhyNot(self) -> str: ...
    @property
    @classmethod
    def Missing(cls) -> GH_Predicate: ...
    @property
    @classmethod
    def Present(cls) -> GH_Predicate: ...
    @property
    @classmethod
    def True(cls) -> GH_Predicate: ...
    @property
    def TypeDescription(self) -> str: ...
    @property
    def TypeName(self) -> str: ...
...
class GH_Transform:
    ...
    def Equals(self, obj: object) -> bool: ...
    @property
    def CompoundTransforms(self) -> MutableSequence[ITransform]: ...
    @property
    def IsValid(self) -> bool: ...
    @property
    def IsValidWhyNot(self) -> str: ...
