...
from Grasshopper.Rhinoceros.Model import ModelEarthAnchorPoint
...
class Param_EarthAnchorPoint:
    ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: MutableSequence[ModelEarthAnchorPoint]) -> bool: ...
    @overload
...
class Param_ModelInstanceDefinition:
    ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: MutableSequence[ModelInstanceDefinition]) -> bool: ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: Iterable[Any]) -> bool: ...
    @overload
    def AddVolatileDataTree(self, tree: GH_Structure) -> bool: ...
...
from Rhino import RhinoDoc
from Rhino.DocObjects import ObjectAttributes
from Grasshopper.Rhinoceros.Model import ModelLayer
from Grasshopper.Kernel.Data import GH_Structure
from Grasshopper.Kernel import GH_ParamData
from System.Windows.Forms import ToolStripDropDown
from GH_IO.Serialization import GH_IWriter
...
class Param_ModelLayer:
    ...
    def AddVolatileData(self, path: GH_Path, index: int, data: object) -> bool: ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: MutableSequence[ModelLayer]) -> bool: ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: Iterable[Any]) -> bool: ...
    @overload
    def AddVolatileDataTree(self, tree: IGH_Structure) -> bool: ...
...
class Param_ModelObject:
    ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: MutableSequence[ModelObject]) -> bool: ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: Iterable[Any]) -> bool: ...
    @overload
    def AddVolatileDataTree(self, tree: GH_Structure) -> bool: ...
