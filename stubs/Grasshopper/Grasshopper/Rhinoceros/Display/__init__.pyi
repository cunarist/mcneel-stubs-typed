...
class Attributes:
    ...
    @WireDensity.setter
    def WireDensity(self, AutoPropertyValue: int | None) -> None: ...
    @overload
    def ToString(self) -> str: ...
...
class Attributes:
    ...
    def Notes(self, AutoPropertyValue: str) -> None: ...
    @PageNumber.setter
    def PageNumber(self, value: int | None) -> None: ...
    @Parent.setter
    def Parent(self, Value: ModelContentName) -> None: ...
    @Path.setter
    def Path(self, Value: ModelContentName) -> None: ...
...
class ModelDisplayMode(ModelContent):
    ...
    @property
    @classmethod
    def Unset(cls) -> ModelDisplayMode: ...
    @overload
    def GetHashCode(self) -> int: ...
    @overload
    def GetType(self) -> type: ...
