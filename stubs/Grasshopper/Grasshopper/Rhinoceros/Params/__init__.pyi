...
from Grasshopper.Kernel import MatchingMode
...
class Param_ModelContent:
    ...
    def AddVolatileData(self, path: GH_Path, index: int, data: object) -> bool: ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: MutableSequence[IGH_ModelContentData]) -> bool: ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: Iterable[Any]) -> bool: ...
    @overload
    def AddVolatileDataTree(self, tree: IGH_Structure) -> bool: ...
...
from System import Guid
from Grasshopper.Kernel import GH_Exposure
from Grasshopper.Rhinoceros import ModelFont
from Grasshopper.Kernel.Data import GH_Structure
from Grasshopper.Kernel import GH_ParamData
from System.Windows.Forms import ToolStripDropDown
from GH_IO.Serialization import GH_IWriter
...
class Param_ModelFont:
    ...
    def AddVolatileData(self, path: GH_Path, index: int, data: object) -> bool: ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: MutableSequence[ModelFont]) -> bool: ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: Iterable[Any]) -> bool: ...
    @overload
    def AddVolatileDataTree(self, tree: GH_Structure) -> bool: ...
...
class Param_ModelMeshingParameters:
    ...
    def AddVolatileData(self, path: GH_Path, index: int, data: object) -> bool: ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: MutableSequence[ModelMeshingParameters]) -> bool: ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: Iterable[Any]) -> bool: ...
    @overload
    def AddVolatileDataTree(self, tree: GH_Structure) -> bool: ...
...
from System import Guid
from Grasshopper.Kernel import GH_Exposure
from Grasshopper.Rhinoceros import ModelUnitSystem
from Grasshopper.Kernel.Data import GH_Structure
from Grasshopper.Kernel import GH_ParamData
from System.Windows.Forms import ToolStripDropDown
from GH_IO.Serialization import GH_IWriter
...
class Param_ModelUnitSystem:
    ...
    def AddVolatileData(self, path: GH_Path, index: int, data: object) -> bool: ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: MutableSequence[ModelUnitSystem]) -> bool: ...
    @overload
    def AddVolatileDataList(self, path: GH_Path, list: Iterable[Any]) -> bool: ...
    @overload
    def AddVolatileDataTree(self, tree: GH_Structure) -> bool: ...
