...
class GH_Canvas:
    ...
    @classmethod
    def DisplayVoronoiWarning(clsAutoPropertyValue: bool) -> None: ...
    @Dock.setter
    ...
    @classmethod
    def NavigationPanDown(clsValue: Keys) -> None: ...
    @NavigationPanLeft.setter
    @classmethod
    def NavigationPanLeft(clsValue: Keys) -> None: ...
    @NavigationPanPixels.setter
    @classmethod
    def NavigationPanPixels(clsValue: int) -> None: ...
    @NavigationPanRight.setter
    @classmethod
    def NavigationPanRight(clsValue: Keys) -> None: ...
    @NavigationPanUp.setter
    @classmethod
    def NavigationPanUp(clsValue: Keys) -> None: ...
    @NavigationZoomFactor.setter
    @classmethod
    def NavigationZoomFactor(clsValue: float) -> None: ...
    @NavigationZoomIn.setter
    @classmethod
    def NavigationZoomIn(clsValue: Keys) -> None: ...
    @NavigationZoomOut.setter
    @classmethod
    def NavigationZoomOut(clsValue: Keys) -> None: ...
    @Padding.setter
