...
class GH_Layout:
    ...
    @property
    def Tabs(self) -> MutableSequence[GH_LayoutTab]: ...
    @overload
...
class GH_LayoutPanel:
    ...
    def Equals(self, obj: object) -> bool: ...
    @property
    def Items(self) -> MutableSequence[GH_LayoutItem]: ...
    @property
    def Name(self) -> str: ...
    @overload
    def GetHashCode(self) -> int: ...
...
class GH_LayoutTab:
    ...
    def Name(self) -> str: ...
    @property
    def Panels(self) -> MutableSequence[GH_LayoutPanel]: ...
    @property
    def Selected(self) -> bool: ...
    @overload
    def GetHashCode(self) -> int: ...
...
class GH_Ribbon:
    ...
    def TabIndex(self) -> int: ...
    @property
    def Tabs(self) -> MutableSequence[GH_RibbonTab]: ...
    @property
    def TabStop(self) -> bool: ...
    @property
    def Tag(self) -> object: ...
...
class GH_RibbonDropdown:
    ...
    def PointToScreen(self, p: Point) -> Point: ...
    @overload
    def PopulateContent(self, proxies: MutableSequence[IGH_ObjectProxy]) -> None: ...
    @overload
    def PreProcessControlMessage(self, msg: Message) -> tuple[PreProcessControlState, Message]: ...
    @overload
    def PreProcessMessage(self, msg: Message) -> tuple[bool, Message]: ...
...
class GH_RibbonPainter:
    ...
    @property
    @classmethod
    def PanelBarHeight(cls) -> int: ...
    @property
    @classmethod
    def PanelCornerRadius(cls) -> int: ...
    @property
    @classmethod
    def TabGripHeight(cls) -> int: ...
    @overload
    def GetHashCode(self) -> int: ...
    @overload
    def GetType(self) -> type: ...
...
class GH_RibbonPanel(GH_RibbonContentBase):
    ...
    def Equals(self, obj: object) -> bool: ...
    @property
    def AllItems(self) -> MutableSequence[GH_RibbonItem]: ...
    @property
    def ClientRegion(self) -> Rectangle: ...
    @property
    def ContentRegion(self) -> Rectangle: ...
    ...
    def Visible(self) -> bool: ...
    @property
    def VisibleItems(self) -> MutableSequence[GH_RibbonItem]: ...
    @overload
    def GetHashCode(self) -> int: ...
    @overload
    def GetType(self) -> type: ...
...
class GH_RibbonTab(GH_RibbonContentBase):
    ...
    def Padding(self) -> Padding: ...
    @property
    def Panels(self) -> MutableSequence[GH_RibbonPanel]: ...
    @property
    def Visible(self) -> bool: ...
    @overload
    def GetHashCode(self) -> int: ...
