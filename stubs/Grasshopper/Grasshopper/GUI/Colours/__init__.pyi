...
class GH_MultiColourPalette:
    ...
    def __init__(self): ...
    @overload
    def ActiveBuckets(self) -> MutableSequence[GH_ColourBucket]: ...
    @overload
    ...
    @property
    def Buckets(self) -> MutableSequence[GH_ColourBucket]: ...
    @property
...
class GH_MultiColourPaletteEventArgs:
    @overload
    def __init__(self, nBuckets: MutableSequence[GH_ColourBucket]): ...
    @overload
    def Equals(self, obj: object) -> bool: ...
    @property
    def ActiveBuckets(self) -> MutableSequence[GH_ColourBucket]: ...
    @property
    def BlankBuckets(self) -> MutableSequence[GH_ColourBucket]: ...
    @property
    def SelectedBuckets(self) -> MutableSequence[GH_ColourBucket]: ...
    @overload
    def GetHashCode(self) -> int: ...
    @overload
    def GetType(self) -> type: ...
...
class GH_MultiColourPicker:
    ...
    def GetChildAtPoint(self, pt: Point, skipValue: GetChildAtPointSkip) -> Control: ...
    @overload
    def GetColours(self) -> MutableSequence[GH_Colour]: ...
    @overload
    def GetContainerControl(self) -> IContainerControl: ...
    @overload
    def GetHashCode(self) -> int: ...
    ...
    def Refresh(self) -> None: ...
    @overload
    def RegisterColours(self, c_list: MutableSequence[GH_Colour]) -> None: ...
    @overload
