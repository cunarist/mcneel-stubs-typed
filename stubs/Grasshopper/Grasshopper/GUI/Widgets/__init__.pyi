...
class GH_AlignWidget(GH_Widget):
    ...
    @classmethod
    def SharedVisible(cls, Value: bool) -> None: ...
    @Visible.setter
...
class GH_CompassWidget(GH_CanvasWidget_FixedObject):
    ...
    @DrawObjects.setter
    @classmethod
    def DrawObjects(cls, Value: bool) -> None: ...
    @DrawSelectionOnly.setter
    @classmethod
    def DrawSelectionOnly(cls, Value: bool) -> None: ...
    @Owner.setter
    def Owner(self, Value: GH_Canvas) -> None: ...
    @Ratio.setter
    def Ratio(self, Value: SizeF) -> None: ...
...
class GH_MarkovWidget(GH_Widget):
    ...
    @DockCorner.setter
    @classmethod
    def DockCorner(cls, Value: GH_MarkovWidgetDock) -> None: ...
    @IconLimit.setter
    @classmethod
    def IconLimit(cls, Value: int) -> None: ...
    @Owner.setter
    def Owner(self, Value: GH_Canvas) -> None: ...
    @SharedVisible.setter
    @classmethod
...
class GH_ProfilerWidget(GH_Widget):
    ...
    @ShowDuration.setter
    @classmethod
    def ShowDuration(cls, Value: bool) -> None: ...
    @Threshold.setter
    @classmethod
    def Threshold(cls, Value: int) -> None: ...
    @Visible.setter
    def Visible(self, Value: bool) -> None: ...
    @overload
    def SetupTooltip(self, canvasPoint: PointF, e: GH_TooltipDisplayEventArgs) -> None: ...
