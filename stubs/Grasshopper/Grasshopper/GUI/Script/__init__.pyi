...
class GH_CodeBlocks:
    ...
    @overload
    def FindAll(self, match: Predicate) -> MutableSequence[GH_CodeBlock]: ...
    @overload
    ...
    @overload
    def GetRange(self, index: int, count: int) -> MutableSequence[GH_CodeBlock]: ...
    @overload
    def GetType(self) -> type: ...
    @overload
...
class GH_ScriptEditor:
    ...
    @overload
    def AppendSourceCode(self, code: MutableSequence[str]) -> None: ...
    @overload
    ...
    @overload
    @staticmethod
    def DefaultAssemblyLocations() -> MutableSequence[str]: ...
    @overload
    def Equals(self, obj: object) -> bool: ...
    @overload
    @staticmethod
    ...
    @property
    @classmethod
    def AutoSolveEnabled(cls) -> bool: ...
    @property
    @classmethod
    def Cache_AppDataDirectory(cls) -> str: ...
    @property
    ...
    @overload
    @staticmethod
    def GetAllCacheFiles() -> MutableSequence[GH_MRU_Entry]: ...
    @overload
    def GetHashCode(self) -> int: ...
    @overload
    ...
    @overload
    def RegisterAssemblies(self, customReferences: MutableSequence[GH_CustomReference]) -> None: ...
    @overload
    ...
    @classmethod
    def AutoSolveEnabled(cls, AutoPropertyValue: bool) -> None: ...
    @EditorFont.setter
