...
class GH_MRU_Server:
    ...
    @property
    def Records(self) -> MutableSequence[GH_MRU_Entry]: ...
    @property
    @classmethod
    def VisibleRecords(cls) -> int: ...
    @overload
    def GetHashCode(self) -> int: ...
    @overload
    def GetType(self) -> type: ...
    ...
    @classmethod
    def VisibleRecords(cls, Value: int) -> None: ...
    @overload
    def ToString(self) -> str: ...
    @overload
...
class GH_TimeSpan:
    ...
    def Bounds(self) -> Rectangle: ...
    @property
    def Entries(self) -> MutableSequence[GH_FileEntry]: ...
    @property
