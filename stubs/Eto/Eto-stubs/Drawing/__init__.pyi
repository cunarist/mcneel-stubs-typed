...
class Point:
    ...
    @overload
    def __rmul__(factor: int, point: Point) -> Point: ...
    @overload
...
class PointF:
    ...
    @overload
    def __rmul__(factor: Single, point: PointF) -> PointF: ...
    @overload
...
class Size:
    ...
    @overload
    def __rmul__(factor: int, size: Size) -> Size: ...
    @overload
...
class SizeF:
    ...
    @overload
    def __rmul__(factor: Single, size: SizeF) -> SizeF: ...
    @overload
