...
class FontFamily(Widget):
    ...
    def Equals(self, obj: Object) -> bool: ...
    @overload
    def FromFiles(fileNames: Set[str]) -> FontFamily: ...
    @overload
    def FromFiles(fileNames: Iterable[str]) -> FontFamily: ...
    @overload
    def FromStreams(streams: Set[Stream]) -> FontFamily: ...
    @overload
...
class Point:
    ...
    @overload
    def __mul__(size: Size, point: Point) -> Point: ...
    @overload
    def __mul__(factor: Single, point: Point) -> PointF: ...
    @overload
    def __mul__(factor: int, point: Point) -> Point: ...
    @overload
    def __mul__(point2: Point, point1: Point) -> Point: ...
    @overload
    def __sub__(size: Size, point: Point) -> Point: ...
    @overload
    def __sub__(point2: Point, point1: Point) -> Point: ...
    @overload
    def __sub__(value: int, point: Point) -> Point: ...
    def __neg__(point: Point) -> Point: ...
    @overload
    def Restrict(self, rectangle: Rectangle) -> None: ...
    @overload
    def Restrict(rectangle: Rectangle, point: Point) -> Point: ...
...
class PointF:
    ...
    @overload
    def __sub__(size: SizeF, point: PointF) -> PointF: ...
    @overload
    def __sub__(value: Single, point: PointF) -> PointF: ...
    @overload
    def __sub__(point2: PointF, point1: PointF) -> PointF: ...
    ...
    def Rotate(self, angle: Single) -> None: ...
    @overload
    def Rotate(angle: Single, point: PointF) -> PointF: ...
    @X.setter
...
class Size:
    ...
    @overload
    def __mul__(factor: Single, size: Size) -> SizeF: ...
    @overload
    def __mul__(size2: Size, size1: Size) -> Size: ...
    @overload
    def __mul__(factor: int, size: Size) -> Size: ...
    @overload
    def __sub__(size2: Size, size1: Size) -> Size: ...
    @overload
    def __sub__(point: Point, size: Size) -> Size: ...
    @overload
    def __sub__(value: int, size: Size) -> Size: ...
...
class SizeF:
    ...
    @overload
    def __mul__(factor: Single, size: SizeF) -> SizeF: ...
    @overload
    def __mul__(size2: SizeF, size1: SizeF) -> SizeF: ...
    @overload
    def __sub__(size2: SizeF, size1: SizeF) -> SizeF: ...
    @overload
    def __sub__(value: Single, size: SizeF) -> SizeF: ...
