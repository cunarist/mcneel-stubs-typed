...
class Platform:
    ...
    @overload
    def Add(self, instantiator: Callable[..., Any]) -> None: ...
    @overload
    def Add(self, type: type, instantiator: Callable[..., Any]) -> None: ...
    @overload
    ...
    def Equals(self, obj: object) -> bool: ...
    @overload
    def Find(self) -> Callable[..., Any]: ...
    @overload
    def Find(self, type: type) -> Callable[..., Any]: ...
    @property
    @classmethod
    ...
    @overload
    def Invoke(self, action: Callable[..., Any]) -> T: ...
    @overload
    ...
    @classmethod
    def AllowReinitialize(cls, value: bool) -> None: ...
    @overload
...
class PropertyStore:
    ...
    @overload
    def Create(self, key: object, create: Callable[..., Any]) -> T: ...
    @overload
    def Equals(self, obj: object) -> bool: ...
    @property
    ...
    @overload
    def Get(self, key: object, defaultValue: Callable[..., Any]) -> T: ...
    @property
    ...
    @overload
    def SetCommand(self, key: object, value: ICommand, setEnabled: Action, addExecute: Action, removeExecute: Action, getParameter: Callable[..., Any]) -> None: ...
    @overload
    def ToString(self) -> str: ...
    @overload
...
class Style:
    ...
    @Provider.setter
    @classmethod
    def Provider(cls, value: IStyleProvider) -> None: ...
    @overload
    def ToString(self) -> str: ...
