...
class ArcCurve(Curve):
    ...
    @overload
    def FilletSurfaceToCurve(self, face: BrepFace, t: float, u: float, v: float, radius: float, alignToCurve: int, railDegree: int, arcDegree: int, arcSliders: Iterable[float], numBezierSrfs: int, tolerance: float, out_fillets: MutableSequence[Brep]) -> Tuple[bool, Iterable[float]]: ...
    @overload
    def FilletSurfaceToRail(self, faceWithCurve: BrepFace, secondFace: BrepFace, u1: float, v1: float, railDegree: int, arcDegree: int, arcSliders: Iterable[float], numBezierSrfs: int, extend: bool, split_type: FilletSurfaceSplitType, tolerance: float, out_fillets: MutableSequence[Brep], out_breps0: MutableSequence[Brep], out_breps1: MutableSequence[Brep]) -> Tuple[bool, Iterable[float]]: ...
    @overload
...
from .Generic import IDictionary
...
class Brep(GeometryBase):
    ...
    @overload
    @staticmethod
    def JoinBreps(brepsToJoin: Iterable[Brep], tolerance: float, angleTolerance: float) -> Tuple[Iterable[Brep], MutableSequence[Any]]: ...
    @overload
    ...
    @overload
    @staticmethod
    def SplitDisjointPieces(brep: Brep) -> Tuple[Iterable[Brep], MutableSequence[Any]]: ...
    @overload
...
class BrepFace(SurfaceProxy):
    ...
    @overload
    def FilletSurfaceToCurve(self, curve: Curve, t: float, u: float, v: float, radius: float, alignToCurve: int, railDegree: int, arcDegree: int, arcSliders: Iterable[float], numBezierSrfs: int, tolerance: float, out_fillets: MutableSequence[Brep]) -> Tuple[bool, Iterable[float]]: ...
    @overload
    ...
    @overload
    def RefitSimplySplitSurface(self, trimCurve3d: Curve, trimProjectionDir: Vector3d, tolerance: float, knotAdditionMode: RefitTrimKnotMode, numInsertKnots: int, Knots: Iterable[float], sectionMode: RefitTrimSectionMode, numNonTrimSpans: int, meetCurve: bool, oneSided: bool, PtActive: Point3d, outputSurface: bool, outputCurve: bool, numSections: int, lowerSurface: MutableSequence[Surface], upperSurface: MutableSequence[Surface], edgeCurve: MutableSequence[Curve], FitMeasurement: float, trimCurveOnSurface: Curve, splitCurve: Curve) -> Tuple[bool, int, float, Curve, Curve]: ...
    @overload
    def RefitSplit(self, curve: Curve, trimProjectionDir: Vector3d, tolerance: float, Knots: Iterable[float], bMeetCurve: bool, divideIntoSections: bool, srfLower: MutableSequence[Surface], srfUpper: MutableSequence[Surface], edgeCurve: MutableSequence[Curve], trimCurveOnSurface: Curve, splitCurve: Curve) -> Tuple[int, Curve, Curve]: ...
    @overload
...
class ComponentStatus:
    ...
    @property
    @classmethod
    def AllSet(cls) -> ComponentStatus: ...
    @property
    @classmethod
    def Clear(cls) -> ComponentStatus: ...
    @property
    @classmethod
    def Damaged(cls) -> ComponentStatus: ...
    @property
    @classmethod
    def Hidden(cls) -> ComponentStatus: ...
    @property
    @classmethod
    def Highlighted(cls) -> ComponentStatus: ...
    @property
    ...
    @property
    @classmethod
    def Locked(cls) -> ComponentStatus: ...
    @property
    @classmethod
    def Selected(cls) -> ComponentStatus: ...
    @property
    @classmethod
    def SelectedPersistent(cls) -> ComponentStatus: ...
    @overload
    def GetHashCode(self) -> int: ...
    @overload
    def GetType(self) -> type: ...
...
class HiddenLineDrawingParameters:
    ...
    @overload
    def AddGeometryAndPlanes(self, geometry: GeometryBase, tag: object, clips: MutableSequence[Plane]) -> bool: ...
    @overload
    def AddGeometryAndPlanes(self, geometry: GeometryBase, xform: Transform, tag: object, clips: MutableSequence[Plane]) -> bool: ...
    @overload
    def AddGeometryAndPlanes(self, geometry: GeometryBase, tag: object, occluding_sections: bool, clips: MutableSequence[Plane]) -> bool: ...
    @overload
    def AddGeometryAndPlanes(self, geometry: GeometryBase, xform: Transform, tag: object, occluding_sections: bool, clips: MutableSequence[Plane]) -> bool: ...
    @overload
    def Equals(self, obj: object) -> bool: ...
    @property
...
class Mesh(GeometryBase):
    ...
    @overload
    def Offset(self, distance: float, solidify: bool, direction: Vector3d) -> Tuple[Mesh, MutableSequence[Any]]: ...
    @overload
...
class MeshExtruder:
    ...
    @overload
    def ExtrudedMesh(self) -> Tuple[bool, Mesh, MutableSequence[Any]]: ...
    @property
    ...
    def GetType(self) -> type: ...
    @overload
    def GetWallFaces(self) -> MutableSequence[int]: ...
    @EdgeBasedUVN.setter
...
class MeshingParameters:
    ...
    @property
    @classmethod
    def Coarse(cls) -> MeshingParameters: ...
    @property
    def ComputeCurvature(self) -> bool: ...
    @property
    @classmethod
    def Default(cls) -> MeshingParameters: ...
    @property
    @classmethod
    def DefaultAnalysisMesh(cls) -> MeshingParameters: ...
    @property
    def DoublePrecision(self) -> bool: ...
    @property
    @classmethod
    def FastRenderMesh(cls) -> MeshingParameters: ...
    @property
    ...
    @property
    @classmethod
    def Minimal(cls) -> MeshingParameters: ...
    @property
    ...
    @property
    @classmethod
    def QualityRenderMesh(cls) -> MeshingParameters: ...
    @property
    ...
    @property
    @classmethod
    def Smooth(cls) -> MeshingParameters: ...
    @property
...
class Plane:
    ...
    @property
    @classmethod
    def WorldXY(cls) -> Plane: ...
    @property
    @classmethod
    def WorldYZ(cls) -> Plane: ...
    @property
    @classmethod
    def WorldZX(cls) -> Plane: ...
    @property
...
class Point3f:
    ...
    @property
    @classmethod
    def Origin(cls) -> Point3f: ...
    @property
    @classmethod
    def Unset(cls) -> Point3f: ...
    @property
    def X(self) -> float: ...
    @property
    def Y(self) -> float: ...
...
class Squisher:
    ...
    @overload
    def SquishMesh(self, sp: SquishParameters, mesh3d: Mesh, marks: Iterable[GeometryBase], squished_marks_out: MutableSequence[GeometryBase]) -> Mesh: ...
    @overload
    def SquishPoint(self, point: Point3d) -> Tuple[bool, Point3d]: ...
    @overload
    def SquishSurface(self, sp: SquishParameters, surface: Surface) -> Brep: ...
    @overload
    def SquishSurface(self, sp: SquishParameters, surface: Surface, marks: Iterable[GeometryBase], squished_marks_out: MutableSequence[GeometryBase]) -> Brep: ...
    @overload
...
class SquishParameters:
    ...
    @property
    @classmethod
    def Default(cls) -> SquishParameters: ...
    @property
...
class SubDCreationOptions:
    ...
    @property
    @classmethod
    def ConvexAndConcaveCornersAndInteriorCreases(cls) -> SubDCreationOptions: ...
    @property
    @classmethod
    def ConvexCornersAndInteriorCreases(cls) -> SubDCreationOptions: ...
    @property
    def ConvexCornerTest(self) -> ConvexCornerOption: ...
    @property
    @classmethod
    def InteriorCreases(cls) -> SubDCreationOptions: ...
    @property
    ...
    @property
    @classmethod
    def Smooth(cls) -> SubDCreationOptions: ...
    @overload
    def GetHashCode(self) -> int: ...
    @overload
    def GetType(self) -> type: ...
...
class SubDDisplayParameters:
    ...
    @property
    @classmethod
    def AdaptiveDisplayMeshQuadMaximum(cls) -> int: ...
    @property
...
class SubDSurfaceInterpolator:
    ...
    @property
    @classmethod
    def MaximumRecommendedInterpolatedVertexCount(cls) -> int: ...
    @overload
    def GetHashCode(self) -> int: ...
    @overload
    def GetType(self) -> type: ...
...
class SubDToBrepOptions:
    ...
    @property
    @classmethod
    def Default(cls) -> SubDToBrepOptions: ...
    @property
    @classmethod
    def DefaultPacked(cls) -> SubDToBrepOptions: ...
    @property
    @classmethod
    def DefaultUnpacked(cls) -> SubDToBrepOptions: ...
    @property
...
class SurfaceFilletBase:
    @overload
    @staticmethod
    def CreateG2ChordalQuinticFilletSrf(faceA: BrepFace, uvA: Point2d, faceB: BrepFace, uvB: Point2d, radius: float, tolerance: float, trimmedBrepsA: MutableSequence[Brep], trimmedBrepsB: MutableSequence[Brep], rail_degree: int, bTrim: bool, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    @staticmethod
    def CreateNonRationalCubicArcsFilletSrf(faceA: BrepFace, uvA: Point2d, faceB: BrepFace, uvB: Point2d, radius: float, tolerance: float, trimmedBrepsA: MutableSequence[Brep], trimmedBrepsB: MutableSequence[Brep], rail_degree: int, bTrim: bool, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    @staticmethod
    def CreateNonRationalCubicFilletSrf(faceA: BrepFace, uvA: Point2d, faceB: BrepFace, uvB: Point2d, radius: float, tolerance: float, trimmedBrepsA: MutableSequence[Brep], trimmedBrepsB: MutableSequence[Brep], rail_degree: int, TanSlider: float, bTrim: bool, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    @staticmethod
    def CreateNonRationalQuarticArcsFilletSrf(faceA: BrepFace, uvA: Point2d, faceB: BrepFace, uvB: Point2d, radius: float, tolerance: float, trimmedBrepsA: MutableSequence[Brep], trimmedBrepsB: MutableSequence[Brep], rail_degree: int, bTrim: bool, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    @staticmethod
    def CreateNonRationalQuarticFilletSrf(faceA: BrepFace, uvA: Point2d, faceB: BrepFace, uvB: Point2d, radius: float, tolerance: float, trimmedBrepsA: MutableSequence[Brep], trimmedBrepsB: MutableSequence[Brep], rail_degree: int, TanSlider: float, InnerSlider: float, bTrim: bool, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    @staticmethod
    def CreateNonRationalQuinticArcsFilletSrf(faceA: BrepFace, uvA: Point2d, faceB: BrepFace, uvB: Point2d, radius: float, tolerance: float, trimmedBrepsA: MutableSequence[Brep], trimmedBrepsB: MutableSequence[Brep], rail_degree: int, bTrim: bool, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    @staticmethod
    def CreateNonRationalQuinticFilletSrf(faceA: BrepFace, uvA: Point2d, faceB: BrepFace, uvB: Point2d, radius: float, tolerance: float, trimmedBrepsA: MutableSequence[Brep], trimmedBrepsB: MutableSequence[Brep], rail_degree: int, TanSlider: float, InnerSlider: float, bTrim: bool, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    @staticmethod
    def CreateRationalArcsFilletSrf(faceA: BrepFace, uvA: Point2d, faceB: BrepFace, uvB: Point2d, radius: float, tolerance: float, trimmedBrepsA: MutableSequence[Brep], trimmedBrepsB: MutableSequence[Brep], rail_degree: int, bTrim: bool, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    def Dispose(self) -> None: ...
    @overload
    def Equals(self, obj: object) -> bool: ...
    @overload
    def G2ChordalQuintic(self, railDegree: int, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    def GetHashCode(self) -> int: ...
    @overload
    def GetType(self) -> type: ...
    ...
    @overload
    def NonRationalCubic(self, railDegree: int, TanSlider: float, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    def NonRationalCubicArcs(self, railDegree: int, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    def NonRationalQuartic(self, railDegree: int, TanSlider: float, InnerSlider: float, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    def NonRationalQuarticArcs(self, railDegree: int, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    def NonRationalQuintic(self, railDegree: int, TanSlider: float, InnerSlider: float, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    def NonRationalQuinticArcs(self, railDegree: int, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    def RationalArcs(self, railDegree: int, bExtend: bool, Fillets: MutableSequence[Brep]) -> bool: ...
    @overload
    def ToString(self) -> str: ...
    @overload
...
class TextEntity(AnnotationBase):
    ...
    @overload
    def CreateCurvesGrouped(self, dimstyle: DimensionStyle, allowOpen: bool, smallCapsScale: float, spacing: float) -> MutableSequence[Iterable[Curve]]: ...
    @overload
    def CreateExtrusions(self, dimstyle: DimensionStyle, height: float, smallCapsScale: float, spacing: float) -> Iterable[Extrusion]: ...
    @overload
    def CreateExtrusionsGrouped(self, dimstyle: DimensionStyle, smallCapsScale: float, height: float, spacing: float) -> MutableSequence[Iterable[Extrusion]]: ...
    @overload
    def CreatePolySurfaces(self, dimstyle: DimensionStyle, height: float, smallCapsScale: float, spacing: float) -> Iterable[Brep]: ...
    @overload
    def CreatePolysurfacesGrouped(self, dimstyle: DimensionStyle, smallCapsScale: float, height: float, spacing: float) -> MutableSequence[Iterable[Brep]]: ...
    @overload
    def CreateSurfaces(self, dimstyle: DimensionStyle, smallCapsScale: float, spacing: float) -> Iterable[Brep]: ...
    @overload
    def CreateSurfacesGrouped(self, dimstyle: DimensionStyle, smallCapsScale: float, spacing: float) -> MutableSequence[Iterable[Brep]]: ...
    @overload
    @staticmethod
...
class Transform:
    ...
    @property
    @classmethod
    def Unset(cls) -> Transform: ...
    @property
    @classmethod
    def ZeroTransformation(cls) -> Transform: ...
    @overload
    def GetEulerZYZ(self) -> Tuple[bool, float, float, float]: ...
    @overload
    def GetHashCode(self) -> int: ...
...
class Unroller:
    ...
    def GetType(self) -> type: ...
    @overload
    def PerformUnroll(self, flatbreps: MutableSequence[Brep]) -> int: ...
    @overload
...
class Vector2f:
    ...
    @property
    @classmethod
    def Unset(cls) -> Vector2f: ...
    @property
    def X(self) -> float: ...
    @property
    @classmethod
    def XAxis(cls) -> Vector2f: ...
    @property
    def Y(self) -> float: ...
    @property
    @classmethod
    def YAxis(cls) -> Vector2f: ...
    @property
    @classmethod
...
class Vector3d:
    ...
    @property
    @classmethod
    def Unset(cls) -> Vector3d: ...
    @property
    def X(self) -> float: ...
    @property
    @classmethod
    def XAxis(cls) -> Vector3d: ...
    @property
    def Y(self) -> float: ...
    @property
    @classmethod
    def YAxis(cls) -> Vector3d: ...
    @property
    def Z(self) -> float: ...
    @property
    @classmethod
    def ZAxis(cls) -> Vector3d: ...
    @property
    @classmethod
...
class Vector3f:
    ...
    @property
    @classmethod
    def Unset(cls) -> Vector3f: ...
    @property
    def X(self) -> float: ...
    @property
    @classmethod
    def XAxis(cls) -> Vector3f: ...
    @property
    def Y(self) -> float: ...
    @property
    @classmethod
    def YAxis(cls) -> Vector3f: ...
    @property
    def Z(self) -> float: ...
    @property
    @classmethod
    def ZAxis(cls) -> Vector3f: ...
    @property
    @classmethod
    def Zero(cls) -> Vector3f: ...
    @overload
    def GetHashCode(self) -> int: ...
    @overload
    def GetType(self) -> type: ...
