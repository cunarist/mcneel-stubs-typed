...
class LicenseData:
    ...
    @BuildType.setter
    def BuildType(self) -> MutableSequence[LicenseBuildType]: ...
    @DateToExpire.setter
    def DateToExpire(self) -> MutableSequence[Nullable]: ...
    @ErrorMessage.setter
    def ErrorMessage(self) -> MutableSequence[str]: ...
    @IsUpgradeFromPreviousVersion.setter
    def IsUpgradeFromPreviousVersion(self) -> MutableSequence[bool]: ...
    @LicenseCount.setter
    def LicenseCount(self) -> MutableSequence[int]: ...
    @LicenseTitle.setter
    def LicenseTitle(self) -> MutableSequence[str]: ...
    @ProductIcon.setter
    def ProductIcon(self) -> MutableSequence[Icon]: ...
    @ProductLicense.setter
    def ProductLicense(self) -> MutableSequence[str]: ...
    @RequiresOnlineValidation.setter
    def RequiresOnlineValidation(self) -> MutableSequence[bool]: ...
    @SerialNumber.setter
    def SerialNumber(self) -> MutableSequence[str]: ...
    def ToString(self) -> str: ...
...
class LicenseStatus:
    ...
    def CheckOutExpirationDate(self) -> MutableSequence[Nullable]: ...
    @CloudZooLeaseExpiration.setter
    def CloudZooLeaseExpiration(self) -> MutableSequence[Nullable]: ...
    @CloudZooLeaseIsValid.setter
    def CloudZooLeaseIsValid(self) -> MutableSequence[bool]: ...
    @ExpirationDate.setter
    def ExpirationDate(self) -> MutableSequence[Nullable]: ...
    @LicenseTitle.setter
    def LicenseTitle(self) -> MutableSequence[str]: ...
    @LicenseType.setter
    def LicenseType(self) -> MutableSequence[LicenseType]: ...
    @PluginId.setter
    def PluginId(self) -> MutableSequence[Guid]: ...
    @ProductIcon.setter
    def ProductIcon(self) -> MutableSequence[Icon]: ...
    @ProductId.setter
    def ProductId(self) -> MutableSequence[Guid]: ...
    @RegisteredOrganization.setter
    def RegisteredOrganization(self) -> MutableSequence[str]: ...
    @RegisteredOwner.setter
    def RegisteredOwner(self) -> MutableSequence[str]: ...
    @SerialNumber.setter
    def SerialNumber(self) -> MutableSequence[str]: ...
    def ToString(self) -> str: ...
...
class RenderPlugIn(PlugIn):
    ...
    def PerferBasicContent(self) -> MutableSequence[bool]: ...
