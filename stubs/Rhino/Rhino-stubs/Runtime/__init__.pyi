...
class Analytics:
    ...
    def AppInstallerId(self) -> MutableSequence[str]: ...
    @AppName.setter
    def AppName(self) -> MutableSequence[str]: ...
    @AppPlatform.setter
    def AppPlatform(self) -> MutableSequence[str]: ...
    @AppVersion.setter
    def AppVersion(self) -> MutableSequence[str]: ...
    @GoogleAnalyticsTrackingID.setter
    def GoogleAnalyticsTrackingID(self) -> MutableSequence[str]: ...
...
class CommonObject:
    ...
    def PerformCorruptionTesting() -> None: ...
...
class HostUtils:
    ...
    def SendDebugToCommandLine() -> None: ...
    @staticmethod
...
class PathPoint:
    ...
    @PointType.setter
    def PointType(self) -> MutableSequence[PointType]: ...
    def ToString(self) -> str: ...
...
class PythonScript:
    ...
    @ContextId.setter
    def ContextId(self) -> MutableSequence[int]: ...
    @Output.setter
    def Output(self) -> MutableSequence[Action]: ...
    @ScriptContextCommand.setter
    def ScriptContextCommand(self) -> MutableSequence[Command]: ...
    @ScriptContextDoc.setter
    def ScriptContextDoc(self) -> MutableSequence[Object]: ...
    @SearchPaths.setter
    def SearchPaths() -> None: ...
...
class ZooClientParameters:
    ...
    def GetType(self) -> Type: ...
    @Capabilities.setter
    def Capabilities(self) -> MutableSequence[LicenseCapabilities]: ...
    @SelectedLicenseType.setter
    def SelectedLicenseType(self) -> MutableSequence[LicenseTypes]: ...
    def ToString(self) -> str: ...
