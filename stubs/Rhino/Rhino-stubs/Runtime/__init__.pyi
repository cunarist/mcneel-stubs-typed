...
class NamedParametersEventArgs:
    ...
    @overload
    def Set(self, name: str, values: Iterable[UInt32]) -> None: ...
    @overload
    ...
    @overload
    def TryGetUints(self, name: str) -> Tuple[bool, Iterable[UInt32]]: ...
    @overload
...
class Pen:
    ...
    @overload
    @property
    def Pattern(self) -> Iterable[Single]: ...
    @overload
    @property
...
class VectorPolylineProc:
    ...
    def __init__(self, object: Object, method: IntPtr): ...
    @overload
    def BeginInvoke(self, argb: int, thickness: Single, dashed: int, capStyle: int, joinStyle: int, count: int, points: IntPtr, callback: AsyncCallback, object: Object) -> IAsyncResult: ...
    @overload
    def Clone(self) -> Object: ...
    @overload
    def DynamicInvoke(self, args: Iterable[Object]) -> Object: ...
    ...
    def GetType(self) -> Type: ...
    @overload
    def Invoke(self, argb: int, thickness: Single, dashed: int, capStyle: int, joinStyle: int, count: int, points: IntPtr) -> None: ...
    @overload
    def ToString(self) -> str: ...
