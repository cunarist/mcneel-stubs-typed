...
class CollapsibleSectionImpl:
    ...
    @ViewModel.setter
    def ViewModel(self) -> MutableSequence[IRdkViewModel]: ...
    def ToString(self) -> str: ...
...
class ICollapsibleSectionHolder:
    ...
    def BackgroundColor(self) -> MutableSequence[Color]: ...
    @BottomMargin.setter
    def BottomMargin(self) -> MutableSequence[int]: ...
    @EmptyText.setter
    def EmptyText(self) -> MutableSequence[str]: ...
    @LeftMargin.setter
    def LeftMargin(self) -> MutableSequence[int]: ...
    @RightMargin.setter
    def RightMargin(self) -> MutableSequence[int]: ...
    @ScrollPosition.setter
    def ScrollPosition(self) -> MutableSequence[int]: ...
    @SettingsPathSubKey.setter
    def SettingsPathSubKey(self) -> MutableSequence[str]: ...
    @TopMargin.setter
    def TopMargin(self) -> MutableSequence[int]: ...
...
class IWindow:
    ...
    @Parent.setter
    def Parent(self) -> MutableSequence[IntPtr]: ...
    @Shown.setter
    def Shown(self) -> MutableSequence[bool]: ...
