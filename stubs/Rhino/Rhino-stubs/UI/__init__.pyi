...
class GetColorEventArgs:
    ...
    def SelectedColor(self) -> MutableSequence[Color]: ...
    def ToString(self) -> str: ...
...
class OpenFileDialog:
    ...
    def GetType(self) -> Type: ...
    @DefaultExt.setter
    def DefaultExt(self) -> MutableSequence[str]: ...
    @FileName.setter
    def FileName(self) -> MutableSequence[str]: ...
    @Filter.setter
    def Filter(self) -> MutableSequence[str]: ...
    @InitialDirectory.setter
    def InitialDirectory(self) -> MutableSequence[str]: ...
    @MultiSelect.setter
...
class OptionsDialogPage(StackedDialogPage):
    ...
    def NavigationTextColor(self) -> MutableSequence[Color]: ...
    @NavigationTextIsBold.setter
    def NavigationTextIsBold(self) -> MutableSequence[bool]: ...
...
class RuiUpdateUi:
    ...
    def Enabled(self) -> MutableSequence[bool]: ...
    @RadioChecked.setter
    def RadioChecked(self) -> MutableSequence[bool]: ...
    @Text.setter
...
class ToolbarFileCollection:
    ...
    def MruSidebarIsVisible() -> None: ...
    @SidebarIsVisible.setter
    def SidebarIsVisible() -> None: ...
    def ToString(self) -> str: ...
