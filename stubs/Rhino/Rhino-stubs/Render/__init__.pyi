...
class RenderMaterial(RenderContent):
    @overload
    def AssignTo(self, or: ObjRef) -> bool: ...
    @overload
...
class Utilities:
    ...
    @overload
    def ShowContentChooser(doc: RhinoDoc, defaultType: Guid, defaultInstanceId: Guid, kinds: RenderContentKind, flags: ContentChooserFlags, presetCategory: str, categories: Iterable[str], types: Iterable[Guid]) -> Tuple[ShowContentChooserResults, Set(Guid)]: ...
