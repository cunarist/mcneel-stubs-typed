...
class AsyncRenderContext:
    ...
    @overload
    @RenderWindow.setter
    def RenderWindow(self) -> MutableSequence[RenderWindow]: ...
    @overload
...
class CreatePreviewEventArgs:
    ...
    @overload
    @PreviewImage.setter
    def PreviewImage(self) -> MutableSequence[Bitmap]: ...
    @overload
...
class CustomRenderContentAttribute:
    ...
    @overload
    @ImageBased.setter
    def ImageBased(self) -> MutableSequence[bool]: ...
    @overload
    @IsBuiltIn.setter
    def IsBuiltIn(self) -> MutableSequence[bool]: ...
    @overload
    @IsElevated.setter
    def IsElevated(self) -> MutableSequence[bool]: ...
    @overload
    @IsHdrCapable.setter
    def IsHdrCapable(self) -> MutableSequence[bool]: ...
    @overload
    @IsLinear.setter
    def IsLinear(self) -> MutableSequence[bool]: ...
    @overload
    @IsNormalMap.setter
    def IsNormalMap(self) -> MutableSequence[bool]: ...
    @overload
    @IsPrivate.setter
    def IsPrivate(self) -> MutableSequence[bool]: ...
    @overload
    def ToString(self) -> str: ...
...
class DecalCreateParams:
    ...
    @overload
    @DecalMapping.setter
    def DecalMapping(self) -> MutableSequence[DecalMapping]: ...
    @overload
    @DecalProjection.setter
    def DecalProjection(self) -> MutableSequence[DecalProjection]: ...
    @overload
    @EndLatitude.setter
    def EndLatitude(self) -> MutableSequence[float]: ...
    @overload
    @EndLongitude.setter
    def EndLongitude(self) -> MutableSequence[float]: ...
    @overload
    @Height.setter
    def Height(self) -> MutableSequence[float]: ...
    @overload
    @MapToInside.setter
    def MapToInside(self) -> MutableSequence[bool]: ...
    @overload
    @MaxU.setter
    def MaxU(self) -> MutableSequence[float]: ...
    @overload
    @MaxV.setter
    def MaxV(self) -> MutableSequence[float]: ...
    @overload
    @MinU.setter
    def MinU(self) -> MutableSequence[float]: ...
    @overload
    @MinV.setter
    def MinV(self) -> MutableSequence[float]: ...
    @overload
    @Origin.setter
    ...
    def StartLatitude(self) -> MutableSequence[float]: ...
    @overload
    @StartLongitude.setter
    def StartLongitude(self) -> MutableSequence[float]: ...
    @overload
    @TextureInstanceId.setter
    def TextureInstanceId(self) -> MutableSequence[Guid]: ...
    @overload
    @Transparency.setter
    def Transparency(self) -> MutableSequence[float]: ...
    @overload
    @VectorAcross.setter
    def VectorAcross(self) -> MutableSequence[Vector3d]: ...
    @overload
    @VectorUp.setter
    def VectorUp(self) -> MutableSequence[Vector3d]: ...
    @overload
    def ToString(self) -> str: ...
...
class Dithering(DocumentOrFreeFloatingBase):
    ...
    @overload
    @Method.setter
    def Method(self) -> MutableSequence[Methods]: ...
    @overload
    @On.setter
    def On(self) -> MutableSequence[bool]: ...
    @overload
    def ToString(self) -> str: ...
...
class GroundPlane(DocumentOrFreeFloatingBase):
    ...
    @overload
    @Altitude.setter
    def Altitude(self) -> MutableSequence[float]: ...
    @overload
    @AutoAltitude.setter
    def AutoAltitude(self) -> MutableSequence[bool]: ...
    @overload
    @Enabled.setter
    def Enabled(self) -> MutableSequence[bool]: ...
    @overload
    @MaterialInstanceId.setter
    def MaterialInstanceId(self) -> MutableSequence[Guid]: ...
    @overload
    @ShadowOnly.setter
    def ShadowOnly(self) -> MutableSequence[bool]: ...
    @overload
    @ShowUnderside.setter
    def ShowUnderside(self) -> MutableSequence[bool]: ...
    @overload
    @TextureOffset.setter
    def TextureOffset(self) -> MutableSequence[Vector2d]: ...
    @overload
    @TextureOffsetLocked.setter
    def TextureOffsetLocked(self) -> MutableSequence[bool]: ...
    @overload
    @TextureRotation.setter
    def TextureRotation(self) -> MutableSequence[float]: ...
    @overload
    @TextureSize.setter
    def TextureSize(self) -> MutableSequence[Vector2d]: ...
    @overload
    @TextureSizeLocked.setter
    def TextureSizeLocked(self) -> MutableSequence[bool]: ...
    @overload
    def ToString(self) -> str: ...
...
class ICurrentEnvironment:
    ...
    @overload
    @ForAnyUsage.setter
    def ForAnyUsage(self) -> MutableSequence[RenderEnvironment]: ...
    @overload
    @ForBackground_CheckMode.setter
    def ForBackground_CheckMode(self) -> MutableSequence[RenderEnvironment]: ...
    @overload
    @ForBackground.setter
    def ForBackground(self) -> MutableSequence[RenderEnvironment]: ...
    @overload
    @ForLighting.setter
    def ForLighting(self) -> MutableSequence[RenderEnvironment]: ...
    @overload
    @ForReflectionAndRefraction.setter
    def ForReflectionAndRefraction(self) -> MutableSequence[RenderEnvironment]: ...
...
class ImageAdjust:
    ...
    @overload
    @Dither.setter
    def Dither(self) -> MutableSequence[Methods]: ...
    @overload
    @Gamma.setter
    def Gamma(self) -> MutableSequence[Single]: ...
    @overload
    def ToString(self) -> str: ...
...
class LinearWorkflow(DocumentOrFreeFloatingBase):
    ...
    def PostProcessFrameBuffer(self) -> MutableSequence[bool]: ...
    @overload
    @PostProcessGamma.setter
    def PostProcessGamma(self) -> MutableSequence[Single]: ...
    @overload
    @PostProcessGammaOn.setter
    def PostProcessGammaOn(self) -> MutableSequence[bool]: ...
    @overload
    @PreProcessColors.setter
    def PreProcessColors(self) -> MutableSequence[bool]: ...
    @overload
    @PreProcessGamma.setter
    def PreProcessGamma(self) -> MutableSequence[Single]: ...
    @overload
    @PreProcessTextures.setter
    def PreProcessTextures(self) -> MutableSequence[bool]: ...
    @overload
    def ToString(self) -> str: ...
...
class MappingTag:
    ...
    @overload
    @MappingCRC.setter
    def MappingCRC(self) -> MutableSequence[UInt32]: ...
    @overload
    @MappingType.setter
    def MappingType(self) -> MutableSequence[TextureMappingType]: ...
    @overload
    @MeshTransform.setter
    def MeshTransform(self) -> MutableSequence[Transform]: ...
    @overload
    def ToString(self) -> str: ...
...
class PreviewAppearance:
    ...
    @overload
    @Scale.setter
    def Scale(self) -> MutableSequence[float]: ...
    @overload
...
class RealtimeDisplayMode:
    ...
    @overload
    @MaxPasses.setter
    def MaxPasses(self) -> MutableSequence[int]: ...
    @overload
    @Paused.setter
    def Paused(self) -> MutableSequence[bool]: ...
    @overload
    @PostEffectsOn.setter
    def PostEffectsOn(self) -> MutableSequence[bool]: ...
    @overload
...
class RenderChannels(DocumentOrFreeFloatingBase):
    ...
    @overload
    @CustomList.setter
    def CustomList(self) -> MutableSequence[Iterable[Guid]]: ...
    @overload
    @Mode.setter
    def Mode(self) -> MutableSequence[Modes]: ...
    @overload
    def ToString(self) -> str: ...
...
class RenderContent:
    ...
    def ChildSlotName(self) -> MutableSequence[str]: ...
    @overload
    @DocumentAssoc.setter
    def DocumentAssoc(self) -> MutableSequence[RhinoDoc]: ...
    @overload
    @Filename.setter
    def Filename(self) -> MutableSequence[str]: ...
    @overload
    @GroupId.setter
    def GroupId(self) -> MutableSequence[Guid]: ...
    @overload
    @Hidden.setter
    ...
    @overload
    @Tags.setter
    def Tags(self) -> MutableSequence[str]: ...
    @overload
...
class RenderMaterial(RenderContent):
    ...
    def DefaultPreviewBackgroundType(self) -> MutableSequence[PreviewBackgroundType]: ...
    @overload
    @DefaultPreviewGeometryType.setter
    def DefaultPreviewGeometryType(self) -> MutableSequence[PreviewGeometryType]: ...
    @overload
    @DefaultPreviewSize.setter
    def DefaultPreviewSize(self) -> MutableSequence[float]: ...
    @overload
    @DocumentAssoc.setter
    def DocumentAssoc(self) -> MutableSequence[RhinoDoc]: ...
    @overload
...
class RenderPipeline:
    ...
    def ConfirmationSeconds(self) -> MutableSequence[int]: ...
    @overload
...
class RenderPrimitiveList:
    ...
    def UseObjectsMappingChannels(self) -> MutableSequence[bool]: ...
    @overload
...
class RenderSettings(CommonObject):
    ...
    @overload
    @AmbientLight.setter
    def AmbientLight(self) -> MutableSequence[Color]: ...
    @overload
    @AntialiasLevel.setter
    def AntialiasLevel(self) -> MutableSequence[AntialiasLevel]: ...
    @overload
    @BackgroundColorBottom.setter
    def BackgroundColorBottom(self) -> MutableSequence[Color]: ...
    @overload
    @BackgroundColorTop.setter
    def BackgroundColorTop(self) -> MutableSequence[Color]: ...
    @overload
    @BackgroundStyle.setter
    def BackgroundStyle(self) -> MutableSequence[BackgroundStyle]: ...
    @overload
    @DepthCue.setter
    def DepthCue(self) -> MutableSequence[bool]: ...
    @overload
    @FlatShade.setter
    def FlatShade(self) -> MutableSequence[bool]: ...
    @overload
    @ImageDpi.setter
    def ImageDpi(self) -> MutableSequence[float]: ...
    @overload
    @ImageSize.setter
    def ImageSize(self) -> MutableSequence[Size]: ...
    @overload
    @ImageUnitSystem.setter
    def ImageUnitSystem(self) -> MutableSequence[UnitSystem]: ...
    @overload
    @NamedView.setter
    def NamedView(self) -> MutableSequence[str]: ...
    @overload
    @RenderAnnotations.setter
    def RenderAnnotations(self) -> MutableSequence[bool]: ...
    @overload
    @RenderBackfaces.setter
    def RenderBackfaces(self) -> MutableSequence[bool]: ...
    @overload
    @RenderCurves.setter
    def RenderCurves(self) -> MutableSequence[bool]: ...
    @overload
    @RenderIsoparams.setter
    def RenderIsoparams(self) -> MutableSequence[bool]: ...
    @overload
    @RenderMeshEdges.setter
    def RenderMeshEdges(self) -> MutableSequence[bool]: ...
    @overload
    @RenderPoints.setter
    def RenderPoints(self) -> MutableSequence[bool]: ...
    @overload
    @RenderSource.setter
    def RenderSource(self) -> MutableSequence[RenderingSources]: ...
    @overload
    @ScaleBackgroundToFit.setter
    def ScaleBackgroundToFit(self) -> MutableSequence[bool]: ...
    @overload
    @ShadowmapLevel.setter
    def ShadowmapLevel(self) -> MutableSequence[int]: ...
    @overload
    @Snapshot.setter
    def Snapshot(self) -> MutableSequence[str]: ...
    @overload
    @SpecificViewport.setter
    def SpecificViewport(self) -> MutableSequence[str]: ...
    @overload
    @TransparentBackground.setter
    def TransparentBackground(self) -> MutableSequence[bool]: ...
    @overload
    @UseHiddenLights.setter
    def UseHiddenLights(self) -> MutableSequence[bool]: ...
    @overload
    @UseViewportSize.setter
    def UseViewportSize(self) -> MutableSequence[bool]: ...
    @overload
    def ToJSON(self, options: SerializationOptions) -> str: ...
    @overload
    def ToString(self) -> str: ...
...
class SafeFrame(DocumentOrFreeFloatingBase):
    ...
    def ActionFrameLinked(self) -> MutableSequence[bool]: ...
    @overload
    @ActionFrameOn.setter
    def ActionFrameOn(self) -> MutableSequence[bool]: ...
    @overload
    @ActionFrameXScale.setter
    def ActionFrameXScale(self) -> MutableSequence[float]: ...
    @overload
    @ActionFrameYScale.setter
    def ActionFrameYScale(self) -> MutableSequence[float]: ...
    @overload
    @Enabled.setter
    def Enabled(self) -> MutableSequence[bool]: ...
    @overload
    @FieldsOn.setter
    def FieldsOn(self) -> MutableSequence[bool]: ...
    @overload
    @LiveFrameOn.setter
    def LiveFrameOn(self) -> MutableSequence[bool]: ...
    @overload
    @PerspectiveOnly.setter
    def PerspectiveOnly(self) -> MutableSequence[bool]: ...
    @overload
    @TitleFrameLinked.setter
    def TitleFrameLinked(self) -> MutableSequence[bool]: ...
    @overload
    @TitleFrameOn.setter
    def TitleFrameOn(self) -> MutableSequence[bool]: ...
    @overload
    @TitleFrameXScale.setter
    def TitleFrameXScale(self) -> MutableSequence[float]: ...
    @overload
    @TitleFrameYScale.setter
    def TitleFrameYScale(self) -> MutableSequence[float]: ...
    @overload
    def ToString(self) -> str: ...
...
class SimulatedEnvironment:
    ...
    def BackgroundImage(self) -> MutableSequence[SimulatedTexture]: ...
    @overload
    @BackgroundProjection.setter
    def BackgroundProjection(self) -> MutableSequence[BackgroundProjections]: ...
    @overload
    @staticmethod
...
class SimulatedTexture:
    ...
    @overload
    @Filtered.setter
    def Filtered(self) -> MutableSequence[bool]: ...
    @overload
    @HasTransparentColor.setter
    def HasTransparentColor(self) -> MutableSequence[bool]: ...
    @overload
    @MappingChannel.setter
    def MappingChannel(self) -> MutableSequence[int]: ...
    @overload
    @Offset.setter
    def Offset(self) -> MutableSequence[Vector2d]: ...
    @overload
    @ProjectionMode.setter
    def ProjectionMode(self) -> MutableSequence[ProjectionModes]: ...
    @overload
    @Repeat.setter
    def Repeat(self) -> MutableSequence[Vector2d]: ...
    @overload
    @Repeating.setter
    def Repeating(self) -> MutableSequence[bool]: ...
    @overload
    @Rotation.setter
    def Rotation(self) -> MutableSequence[float]: ...
    @overload
    @TransparentColor.setter
    def TransparentColor(self) -> MutableSequence[Color4f]: ...
    @overload
    @TransparentColorSensitivity.setter
    def TransparentColorSensitivity(self) -> MutableSequence[float]: ...
    @overload
...
class Skylight(DocumentOrFreeFloatingBase):
    ...
    def CustomEnvironment(self) -> MutableSequence[Guid]: ...
    @overload
    @CustomEnvironmentOn.setter
    def CustomEnvironmentOn(self) -> MutableSequence[bool]: ...
    @overload
    @Enabled.setter
    def Enabled(self) -> MutableSequence[bool]: ...
    @overload
...
class Sun(DocumentOrFreeFloatingBase):
    ...
    def DaylightSaving(self) -> MutableSequence[bool]: ...
    @overload
    @DaylightSavingMinutes.setter
    def DaylightSavingMinutes(self) -> MutableSequence[int]: ...
    @overload
    @Enabled.setter
    def Enabled(self) -> MutableSequence[bool]: ...
    @overload
    ...
    def ManualControl(self) -> MutableSequence[bool]: ...
    @overload
    @North.setter
    def North(self) -> MutableSequence[float]: ...
    @overload
    @SkylightOn.setter
    def SkylightOn(self) -> MutableSequence[bool]: ...
    @overload
    @TimeZone.setter
    def TimeZone(self) -> MutableSequence[float]: ...
    @overload
...
class TextureMapping(ModelComponent):
    ...
    def NormalTransform(self) -> MutableSequence[Transform]: ...
    @overload
    @PrimativeTransform.setter
    def PrimativeTransform(self) -> MutableSequence[Transform]: ...
    @overload
    @PrimitiveTransform.setter
    def PrimitiveTransform(self) -> MutableSequence[Transform]: ...
    @overload
    @UvwTransform.setter
...
class TwoColorRenderTexture(RenderTexture):
    ...
    @overload
    @Color1.setter
    def Color1(self) -> MutableSequence[Color4f]: ...
    @overload
    @Color2.setter
    def Color2(self) -> MutableSequence[Color4f]: ...
    @overload
    @DocumentAssoc.setter
    def DocumentAssoc(self) -> MutableSequence[RhinoDoc]: ...
    @overload
    ...
    @overload
    @SuperSample.setter
    def SuperSample(self) -> MutableSequence[bool]: ...
    @overload
    @SwapColors.setter
    def SwapColors(self) -> MutableSequence[bool]: ...
    @overload
    @Tags.setter
    def Tags(self) -> MutableSequence[str]: ...
    @overload
    @Texture1Amount.setter
    def Texture1Amount(self) -> MutableSequence[float]: ...
    @overload
    @Texture1On.setter
    def Texture1On(self) -> MutableSequence[bool]: ...
    @overload
    @Texture2Amount.setter
    def Texture2Amount(self) -> MutableSequence[float]: ...
    @overload
    @Texture2On.setter
    def Texture2On(self) -> MutableSequence[bool]: ...
    @overload
    def SetChild(self, renderContent: RenderContent, childSlotName: str) -> bool: ...
    @overload
    def SetChildSlotAmount(self, childSlotName: str, amount: float, cc: ChangeContexts) -> None: ...
...
class Utilities:
    ...
    def ShowIncompatibleEnvironments() -> None: ...
    @overload
    @ShowIncompatibleMaterials.setter
    def ShowIncompatibleMaterials() -> None: ...
    @overload
    @ShowIncompatibleTextures.setter
    def ShowIncompatibleTextures() -> None: ...
    @overload
    @staticmethod
