...
class CustomPostEffectAttribute:
    ...
    def CanDisplayHelp(self) -> MutableSequence[bool]: ...
    @overload
    @ExecuteWhileRenderingDelay.setter
    def ExecuteWhileRenderingDelay(self) -> MutableSequence[int]: ...
    @overload
    @ExecuteWhileRenderingOption.setter
    def ExecuteWhileRenderingOption(self) -> MutableSequence[PostEffectExecuteWhileRenderingOptions]: ...
    @overload
    @Name.setter
    def Name(self) -> MutableSequence[str]: ...
    @overload
    @PostEffectType.setter
    def PostEffectType(self) -> MutableSequence[PostEffectType]: ...
    @overload
    @Styles.setter
    def Styles(self) -> MutableSequence[PostEffectStyles]: ...
    @overload
...
class PostEffect:
    ...
    @overload
    @SerialNumber.setter
    def SerialNumber(self) -> MutableSequence[int]: ...
    @overload
    @Shown.setter
