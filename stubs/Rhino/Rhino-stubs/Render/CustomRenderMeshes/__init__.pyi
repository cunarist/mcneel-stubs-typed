...
class RenderMeshes:
    @overload
    def __init__(self, doc: RhinoDoc, objectId: Guid, renderMeshProviderId: Guid, runningHash: UInt32): ...
    @overload
    def __init__(self, doc: RhinoDoc, objectId: Guid, renderMeshProviderId: Guid, runningHash: UInt32, flags: UInt32): ...
    ...
    @overload
    @Hash.setter
    def Hash(self, value: UInt32) -> None: ...
    @overload
    def ToString(self) -> str: ...
