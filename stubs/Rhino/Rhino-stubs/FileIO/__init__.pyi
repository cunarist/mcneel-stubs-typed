...
class File3dm:
    ...
    @property
    def DimStyles(self) -> IterableDimensionStyle]: ...
    @property
    def HatchPatterns(self) -> IterableHatchPattern]: ...
    @property
    def InstanceDefinitions(self) -> IterableInstanceDefinitionGeometry]: ...
    @property
    def LastEdited(self) -> DateTime: ...
    @property
    def LastEditedBy(self) -> str: ...
    @property
    def Layers(self) -> IterableLayer]: ...
    @property
    def Linetypes(self) -> IterableLinetype]: ...
    @property
    def Manifest(self) -> ManifestTable: ...
    @property
    def Materials(self) -> IterableMaterial]: ...
    @property
    def NamedConstructionPlanes(self) -> IterableConstructionPlane]: ...
    @property
    def NamedViews(self) -> IterableViewInfo]: ...
    @property
    ...
    @property
    def Views(self) -> IterableViewInfo]: ...
    def GetHashCode(self) -> int: ...
