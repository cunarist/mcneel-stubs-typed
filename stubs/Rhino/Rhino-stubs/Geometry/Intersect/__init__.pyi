...
class MeshInterference:
    ...
    @overload
    @HitPoints.setter
    def HitPoints(self) -> MutableSequence[Iterable[Point3d]]: ...
    @overload
    @IndexA.setter
    def IndexA(self) -> MutableSequence[int]: ...
    @overload
    @IndexB.setter
    def IndexB(self) -> MutableSequence[int]: ...
    @overload
    def ToString(self) -> str: ...
...
class RayShootEvent:
    ...
    def BrepFaceIndex(self) -> MutableSequence[int]: ...
    @overload
    @GeometryIndex.setter
    def GeometryIndex(self) -> MutableSequence[int]: ...
    @overload
    @Point.setter
