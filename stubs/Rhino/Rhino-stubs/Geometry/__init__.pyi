...
class Interval:
    ...
    @overload
    def __add__(number: float, interval: Interval) -> Interval: ...
...
class Point2d:
    ...
    @overload
    def __add__(vector: Vector2d, point: Point2d) -> Point2d: ...
    @overload
...
class Point3d:
    ...
    @overload
    def __add__(vector: Vector3d, point: Point3d) -> Point3d: ...
...
class Vector3f:
    ...
    @overload
    def __add__(point: Point3f, vector: Vector3f) -> Point3f: ...
    @overload
