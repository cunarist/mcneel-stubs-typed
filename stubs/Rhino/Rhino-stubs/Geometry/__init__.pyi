...
class ClippingPlaneSurface(PlaneSurface):
    ...
    def GetBoundingBox(self, plane: Plane) -> Tuple[BoundingBox, Box]: ...
    @overload
    def GetClipParticipation(self) -> Tuple[Iterable[Guid], Iterable[int], bool]: ...
    @overload
...
class SubD(GeometryBase):
    ...
    @overload
    @staticmethod
    def CreateGlobeSphere(sphere: Sphere, vertexLocation: SubDComponentLocation, axialFaceCount: UInt32, equatorialFaceCount: UInt32) -> SubD: ...
    @overload
    @staticmethod
    def CreateIcosahedron(sphere: Sphere, vertexLocation: SubDComponentLocation) -> SubD: ...
    @overload
    @staticmethod
    def CreateQuadSphere(sphere: Sphere, vertexLocation: SubDComponentLocation, quadSubdivisionLevel: UInt32) -> SubD: ...
    @overload
    @staticmethod
    def CreateTriSphere(sphere: Sphere, vertexLocation: SubDComponentLocation, triSubdivisionLevel: UInt32) -> SubD: ...
    @overload
    def DataCRC(self, currentRemainder: UInt32) -> UInt32: ...
    @overload
    def DeleteAllUserStrings(self) -> None: ...
    ...
    @overload
    def InterpolateSurfacePoints(self, vertexIndices: Iterable[UInt32], surfacePoints: Iterable[Point3d]) -> bool: ...
    @overload
    def IsValidWithLog(self) -> Tuple[bool, str]: ...
    @overload
    @staticmethod
    ...
    def SetUserString(self, key: str, value: str) -> bool: ...
    @overload
    def SetVertexSurfacePoint(self, vertexIndex: UInt32, surfacePoint: Point3d) -> bool: ...
    @overload
    def Subdivide(self) -> bool: ...
    @overload
    def Subdivide(self, faceIndices: Iterable[int]) -> bool: ...
    ...
    def Transform(self, xform: Transform) -> bool: ...
    @overload
    def TransformComponents(self, components: Iterable[ComponentIndex], xform: Transform, componentLocation: SubDComponentLocation) -> UInt32: ...
    @overload
    def Translate(self, translationVector: Vector3d) -> bool: ...
    @overload
    def Translate(self, x: float, y: float, z: float) -> bool: ...
    ...
    @overload
    def UpdateSurfaceMeshCache(self, lazyUpdate: bool) -> UInt32: ...
...
class SubDSurfaceInterpolator:
    ...
    @overload
    @staticmethod
    def CreateFromMarkedVertices(subd: SubD, interpolatedVerticesMark: bool) -> Tuple[SubDSurfaceInterpolator, UInt32]: ...
    @overload
    @staticmethod
    def CreateFromSelectedVertices(subd: SubD) -> Tuple[SubDSurfaceInterpolator, UInt32]: ...
    @overload
    @staticmethod
    def CreateFromSubD(subd: SubD) -> Tuple[SubDSurfaceInterpolator, UInt32]: ...
    @overload
    @staticmethod
    def CreateFromVertexIdList(subd: SubD, vertexIndices: Iterable[UInt32]) -> Tuple[SubDSurfaceInterpolator, UInt32]: ...
    @overload
    def Dispose(self) -> None: ...
    @overload
    def Equals(self, obj: Object) -> bool: ...
    @overload
    def FixedVertexCount(self) -> UInt32: ...
    @overload
    @property
    def ContextId(self) -> Guid: ...
    @overload
    @property
    def MaximumRecommendedInterpolatedVertexCount() -> UInt32: ...
    @overload
    def GetHashCode(self) -> int: ...
    @overload
    def GetType(self) -> Type: ...
    @overload
    def InterpolatedVertexCount(self) -> UInt32: ...
    @overload
    def InterpolatedVertexIndex(self, vertexId: UInt32) -> UInt32: ...
    @overload
    def IsInterpolatedVertex(self, vertex: SubDVertex) -> bool: ...
    @overload
    def IsInterpolatedVertex(self, vertexId: UInt32) -> bool: ...
    @overload
    @ContextId.setter
    ...
    @overload
    def VertexIdList(self) -> Iterable[UInt32]: ...
