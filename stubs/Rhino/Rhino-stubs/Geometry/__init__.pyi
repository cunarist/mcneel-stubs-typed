...
class Brep(GeometryBase):
    ...
    @overload
    def CreateFromSweep(rail1: Curve, rail2: Curve, shapes: Iterable[Curve], start: Point3d, end: Point3d, closed: bool, tolerance: float, rebuild: SweepRebuild, rebuildPointCount: int, refitTolerance: float, preserveHeight: bool, autoAdjust: bool) -> Set[Brep]: ...
    @overload
    ...
    def DuplicateNakedEdgeCurves(self, nakedOuter: bool, nakedInner: bool) -> Set[Curve]: ...
    ...
    def GetConnectedComponents(self) -> Set[Brep]: ...
...
class Interval:
    ...
    def __eq__(b: Interval, a: Interval) -> bool: ...
    def __gt__(b: Interval, a: Interval) -> bool: ...
    def __ge__(b: Interval, a: Interval) -> bool: ...
    def __ne__(b: Interval, a: Interval) -> bool: ...
    def __lt__(b: Interval, a: Interval) -> bool: ...
    def __le__(b: Interval, a: Interval) -> bool: ...
    @overload
    def __sub__(number: float, interval: Interval) -> Interval: ...
    @overload
    ...
    def Reverse(self) -> None: ...
    @Item.setter
    def Item(self, value: float, index: int) -> None: ...
    @T0.setter
...
class Mesh(GeometryBase):
    ...
    @overload
    def CreateContourCurves(meshToContour: Mesh, sectionPlane: Plane, tolerance: float) -> Set[Curve]: ...
    @overload
    def CreateContourCurves(meshToContour: Mesh, contourStart: Point3d, contourEnd: Point3d, interval: float, tolerance: float) -> Set[Curve]: ...
    @overload
...
class Point2d:
    ...
    @overload
    def __add__(point2: Point2d, point1: Point2d) -> Point2d: ...
    def __truediv__(t: float, point: Point2d) -> Point2d: ...
    def __eq__(b: Point2d, a: Point2d) -> bool: ...
    def __gt__(b: Point2d, a: Point2d) -> bool: ...
    def __ge__(b: Point2d, a: Point2d) -> bool: ...
    def __ne__(b: Point2d, a: Point2d) -> bool: ...
    def __lt__(b: Point2d, a: Point2d) -> bool: ...
    def __le__(b: Point2d, a: Point2d) -> bool: ...
    @overload
    def __rmul__(point: Point2d, t: float) -> Point2d: ...
    @overload
    def __mul__(t: float, point: Point2d) -> Point2d: ...
    @overload
    def __sub__(point2: Point2d, point1: Point2d) -> Vector2d: ...
    @overload
    def __sub__(vector: Vector2d, point: Point2d) -> Point2d: ...
    @Item.setter
    def Item(self, value: float, index: int) -> None: ...
    @X.setter
    def X(self, value: float) -> None: ...
    ...
    def Y(self, value: float) -> None: ...
    @overload
    def Subtract(vector: Vector2d, point: Point2d) -> Point2d: ...
    @overload
    def Subtract(point2: Point2d, point1: Point2d) -> Vector2d: ...
    @overload
    def ToString(self) -> str: ...
    @overload
    def ToString(self, formatProvider: IFormatProvider, format: str) -> str: ...
...
class Point3d:
    ...
    def __truediv__(t: float, point: Point3d) -> Point3d: ...
    def __eq__(b: Point3d, a: Point3d) -> bool: ...
    @overload
    def op_Explicit(vector: Vector3d) -> Point3d: ...
    @overload
    def op_Explicit(point: Point3d) -> Vector3d: ...
    def __gt__(b: Point3d, a: Point3d) -> bool: ...
    def __ge__(b: Point3d, a: Point3d) -> bool: ...
    @overload
    def op_Implicit(pt: Point3d) -> ControlPoint: ...
    @overload
    def op_Implicit(point: Point3f) -> Point3d: ...
    def __ne__(b: Point3d, a: Point3d) -> bool: ...
    def __lt__(b: Point3d, a: Point3d) -> bool: ...
    def __le__(b: Point3d, a: Point3d) -> bool: ...
    @overload
    def __rmul__(point: Point3d, t: float) -> Point3d: ...
    @overload
    def __mul__(t: float, point: Point3d) -> Point3d: ...
    @overload
    def __sub__(point2: Point3d, point1: Point3d) -> Vector3d: ...
    @overload
    def __sub__(vector: Vector3d, point: Point3d) -> Point3d: ...
    ...
    @Z.setter
    def Z(self, value: float) -> None: ...
    def SortAndCullPointList(minimumDistance: float, points: Iterable[Point3d]) -> Set[Point3d]: ...
    @overload
    def Subtract(point2: Point3d, point1: Point3d) -> Vector3d: ...
    @overload
    def Subtract(vector: Vector3d, point: Point3d) -> Point3d: ...
    @overload
    def ToString(self) -> str: ...
    @overload
    def ToString(self, formatProvider: IFormatProvider, format: str) -> str: ...
    def Transform(self, xform: Transform) -> None: ...
    def TryParse(result: Point3d) -> Tuple[bool, Point3d]: ...
...
class Point3f:
    ...
    @overload
    def __mul__(value: Single, point: Point3f) -> Point3f: ...
    def __sub__(point2: Point3f, point1: Point3f) -> Vector3f: ...
    @X.setter
    def X(self, value: Single) -> None: ...
    @Y.setter
    def Y(self, value: Single) -> None: ...
    ...
    def Subtract(point2: Point3f, point1: Point3f) -> Vector3f: ...
    @overload
    def ToString(self) -> str: ...
    @overload
    def ToString(self, formatProvider: IFormatProvider, format: str) -> str: ...
...
class Squisher:
    ...
    def GetMesh2dEdges(self) -> Set[Line]: ...
    def GetMesh3dEdges(self) -> Set[Line]: ...
...
class SubD(GeometryBase):
    ...
    def JoinSubDs(subdsToJoin: Iterable[SubD], tolerance: float, joinedEdgesAreCreases: bool) -> Set[SubD]: ...
    @overload
    def MergeAllCoplanarFaces(self, tolerance: float) -> bool: ...
    @overload
    def MergeAllCoplanarFaces(self, tolerance: float, angleTolerance: float) -> bool: ...
...
class Vector2d:
    ...
    @overload
    def __mul__(t: float, vector: Vector2d) -> Vector2d: ...
    @overload
    def __mul__(vector2: Vector2d, vector1: Vector2d) -> float: ...
    def __sub__(vector2: Vector2d, vector1: Vector2d) -> Vector2d: ...
    ...
    @Y.setter
    def Y(self, value: float) -> None: ...
    def Subtract(vector2: Vector2d, vector1: Vector2d) -> Vector2d: ...
    @overload
    def ToString(self) -> str: ...
    @overload
    def ToString(self, formatProvider: IFormatProvider, format: str) -> str: ...
...
class Vector3d:
    ...
    @overload
    def __mul__(t: float, vector: Vector3d) -> Vector3d: ...
    def __sub__(vector2: Vector3d, vector1: Vector3d) -> Vector3d: ...
    def __neg__(vector: Vector3d) -> Vector3d: ...
    def PerpendicularTo(self, other: Vector3d) -> bool: ...
    def Reverse(self) -> bool: ...
    def Rotate(self, rotationAxis: Vector3d, angleRadians: float) -> bool: ...
    @Item.setter
    def Item(self, value: float, index: int) -> None: ...
    @X.setter
    def X(self, value: float) -> None: ...
    ...
    @Z.setter
    def Z(self, value: float) -> None: ...
    def Subtract(vector2: Vector3d, vector1: Vector3d) -> Vector3d: ...
    @overload
    def ToString(self) -> str: ...
    @overload
    def ToString(self, formatProvider: IFormatProvider, format: str) -> str: ...
    ...
    def Unitize(self) -> bool: ...
    @overload
    def VectorAngle(b: Vector3d, a: Vector3d) -> float: ...
    @overload
    def VectorAngle(b: Vector3d, a: Vector3d, plane: Plane) -> float: ...
    @overload
    def VectorAngle(v2: Vector3d, v1: Vector3d, vNormal: Vector3d) -> float: ...
...
class Vector3f:
    ...
    @overload
    def __truediv__(t: Single, vector: Vector3f) -> Vector3f: ...
    @overload
    def __truediv__(t: float, vector: Vector3f) -> Vector3f: ...
    def __eq__(b: Vector3f, a: Vector3f) -> bool: ...
    def op_Explicit(vector: Vector3d) -> Vector3f: ...
    def __gt__(b: Vector3f, a: Vector3f) -> bool: ...
    def __ge__(b: Vector3f, a: Vector3f) -> bool: ...
    def __ne__(b: Vector3f, a: Vector3f) -> bool: ...
    def __lt__(b: Vector3f, a: Vector3f) -> bool: ...
    def __le__(b: Vector3f, a: Vector3f) -> bool: ...
    @overload
    def __rmul__(vector: Vector3f, t: Single) -> Vector3f: ...
    @overload
    def __mul__(t: Single, vector: Vector3f) -> Vector3f: ...
    @overload
    def __mul__(point2: Vector3f, point1: Vector3f) -> float: ...
    def __sub__(vector2: Vector3f, vector1: Vector3f) -> Vector3f: ...
    def __neg__(vector: Vector3f) -> Vector3f: ...
    def PerpendicularTo(self, other: Vector3f) -> bool: ...
    def Reverse(self) -> bool: ...
    def Rotate(self, rotationAxis: Vector3f, angleRadians: float) -> bool: ...
    @X.setter
    def X(self, value: Single) -> None: ...
    @Y.setter
    def Y(self, value: Single) -> None: ...
    @Z.setter
    def Z(self, value: Single) -> None: ...
    def Subtract(vector2: Vector3f, vector1: Vector3f) -> Vector3f: ...
    @overload
    def ToString(self) -> str: ...
    @overload
    def ToString(self, formatProvider: IFormatProvider, format: str) -> str: ...
