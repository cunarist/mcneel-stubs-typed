...
class MeshNgon:
    ...
    def Create(meshVertexIndexList: Iterableint], meshFaceIndexList: Iterableint]) -> MeshNgon: ...
    @overload
    ...
    def Set(self, meshVertexIndexList: Iterableint], meshFaceIndexList: Iterableint]) -> None: ...
    def ToString(self) -> str: ...
