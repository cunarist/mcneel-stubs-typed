...
class MeshFaceList:
    ...
    @overload
    @property
    def Item(self) -> Sequence[MeshFace]: ...
    @overload
    @property
...
class MeshFaceNormalList:
    ...
    @overload
    @property
    def Item(self) -> Sequence[Vector3f]: ...
    @overload
    def GetEnumerator(self) -> IEnumerator: ...
    @overload
    def GetHashCode(self) -> int: ...
...
class MeshNgonList:
    ...
    @overload
    @property
    def Item(self) -> Sequence[MeshNgon]: ...
    @overload
    @property
...
class MeshTextureCoordinateList:
    ...
    @overload
    @property
    def Item(self) -> Sequence[Point2f]: ...
    @overload
    def GetEnumerator(self) -> IEnumerator: ...
    @overload
    def GetHashCode(self) -> int: ...
...
class MeshTopologyVertexList:
    ...
    @overload
    @property
    def Item(self) -> Sequence[Point3f]: ...
    @overload
    def GetEnumerator(self) -> IEnumerator: ...
    @overload
    def GetHashCode(self) -> int: ...
...
class NurbsCurvePointList:
    ...
    @overload
    @property
    def Item(self) -> Sequence[ControlPoint]: ...
    @overload
    @property
