...
class StringParserSettings:
    ...
    def DefaultAngleUnitSystem(self) -> MutableSequence[AngleUnitSystem]: ...
    @overload
    @DefaultLengthUnitSystem.setter
    def DefaultLengthUnitSystem(self) -> MutableSequence[UnitSystem]: ...
    @overload
    @ParseAddition.setter
    def ParseAddition(self) -> MutableSequence[bool]: ...
    @overload
    @ParseArcDegreesMinutesSeconds.setter
    def ParseArcDegreesMinutesSeconds(self) -> MutableSequence[bool]: ...
    @overload
    @ParseArithmeticExpression.setter
    def ParseArithmeticExpression(self) -> MutableSequence[bool]: ...
    @overload
    @ParseCommaAsDecimalPoint.setter
    def ParseCommaAsDecimalPoint(self) -> MutableSequence[bool]: ...
    @overload
    @ParseCommaAsDigitSeparator.setter
    def ParseCommaAsDigitSeparator(self) -> MutableSequence[bool]: ...
    @overload
    @ParseDAsExponentInScientificENotation.setter
    def ParseDAsExponentInScientificENotation(self) -> MutableSequence[bool]: ...
    @overload
    @ParseDivision.setter
    def ParseDivision(self) -> MutableSequence[bool]: ...
    @overload
    @ParseExplicitFormulaExpression.setter
    def ParseExplicitFormulaExpression(self) -> MutableSequence[bool]: ...
    @overload
    @ParseFeetInches.setter
    def ParseFeetInches(self) -> MutableSequence[bool]: ...
    @overload
    @ParseFullStopAsDecimalPoint.setter
    def ParseFullStopAsDecimalPoint(self) -> MutableSequence[bool]: ...
    @overload
    @ParseFullStopAsDigitSeparator.setter
    def ParseFullStopAsDigitSeparator(self) -> MutableSequence[bool]: ...
    @overload
    @ParseHyphenAsNumberDash.setter
    def ParseHyphenAsNumberDash(self) -> MutableSequence[bool]: ...
    @overload
    @ParseHyphenMinusAsNumberDash.setter
    def ParseHyphenMinusAsNumberDash(self) -> MutableSequence[bool]: ...
    @overload
    @ParseIntegerDashFraction.setter
    def ParseIntegerDashFraction(self) -> MutableSequence[bool]: ...
    @overload
    @ParseLeadingWhiteSpace.setter
    def ParseLeadingWhiteSpace(self) -> MutableSequence[bool]: ...
    @overload
    @ParseMathFunctions.setter
    def ParseMathFunctions(self) -> MutableSequence[bool]: ...
    @overload
    @ParseMultiplication.setter
    def ParseMultiplication(self) -> MutableSequence[bool]: ...
    @overload
    @ParsePairedParentheses.setter
    def ParsePairedParentheses(self) -> MutableSequence[bool]: ...
    @overload
    @ParsePi.setter
    def ParsePi(self) -> MutableSequence[bool]: ...
    @overload
    @ParseRationalNumber.setter
    def ParseRationalNumber(self) -> MutableSequence[bool]: ...
    @overload
    @ParseScientificENotation.setter
    def ParseScientificENotation(self) -> MutableSequence[bool]: ...
    @overload
    @ParseSignificandDigitSeparators.setter
    def ParseSignificandDigitSeparators(self) -> MutableSequence[bool]: ...
    @overload
    @ParseSignificandFractionalPart.setter
    def ParseSignificandFractionalPart(self) -> MutableSequence[bool]: ...
    @overload
    @ParseSignificandIntegerPart.setter
    def ParseSignificandIntegerPart(self) -> MutableSequence[bool]: ...
    @overload
    @ParseSpaceAsDigitSeparator.setter
    def ParseSpaceAsDigitSeparator(self) -> MutableSequence[bool]: ...
    @overload
    @ParseSubtraction.setter
    def ParseSubtraction(self) -> MutableSequence[bool]: ...
    @overload
    @ParseSurveyorsNotation.setter
    def ParseSurveyorsNotation(self) -> MutableSequence[bool]: ...
    @overload
    @ParseUnaryMinus.setter
    def ParseUnaryMinus(self) -> MutableSequence[bool]: ...
    @overload
    @ParseUnaryPlus.setter
    def ParseUnaryPlus(self) -> MutableSequence[bool]: ...
    @overload
    @PreferedLocaleId.setter
    def PreferedLocaleId(self) -> MutableSequence[UInt32]: ...
    @overload
