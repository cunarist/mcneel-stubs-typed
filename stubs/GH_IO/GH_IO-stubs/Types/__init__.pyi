...
class GH_Item:
    ...
    @overload
    def __init__(self, item_name: str, item_data: Iterable[Byte]): ...
    @overload
    ...
    @overload
    def __init__(self, item_name: str, item_index: int, item_data: Iterable[Byte]): ...
    @overload
    ...
    @overload
    @property
    def _bytearray(self) -> Iterable[Byte]: ...
    @overload
    @property
